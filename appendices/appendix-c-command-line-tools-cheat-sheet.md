...
- [C.1 Compiler Tools](#c1-compiler-tools)
  - [`clang` / `clang++`](#clang-clang)
  - [`clang-cl`](#clang-cl)
- [C.2 IR Tools](#c2-ir-tools)
  - [`opt`](#opt)
  - [`llc`](#llc)
  - [`llvm-as` / `llvm-dis`](#llvm-as-llvm-dis)
  - [`llvm-link`](#llvm-link)
  - [`llvm-extract`](#llvm-extract)
- [C.3 Object and Binary Tools](#c3-object-and-binary-tools)
  - [`llvm-ar`](#llvm-ar)
  - [`llvm-nm`](#llvm-nm)
  ...
  - [`llvm-size`](#llvm-size)
  - [`llvm-readelf` / `llvm-readobj`](#llvm-readelf-llvm-readobj)
- [C.4 Debug Info Tools](#c4-debug-info-tools)
  - [`llvm-dwarfdump`](#llvm-dwarfdump)
  - [`llvm-symbolizer`](#llvm-symbolizer)
  - [`llvm-dwp`](#llvm-dwp)
- [C.5 Profile Tools](#c5-profile-tools)
  - [`llvm-profdata`](#llvm-profdata)
  - [`llvm-cov`](#llvm-cov)
  - [`llvm-profgen`](#llvm-profgen)
- [C.6 Analysis Tools](#c6-analysis-tools)
  - [`llvm-mca` (Machine Code Analyzer)](#llvm-mca-machine-code-analyzer)
  - [`llvm-stress`](#llvm-stress)
  - [`llvm-reduce`](#llvm-reduce)
- [C.7 JIT Tools](#c7-jit-tools)
  - [`lli`](#lli)
  - [`llvm-jitlink`](#llvm-jitlink)
- [C.8 Linker (LLD)](#c8-linker-lld)
- [C.9 TableGen](#c9-tablegen)
  - [`llvm-tblgen`](#llvm-tblgen)
- [C.10 MLIR Tools](#c10-mlir-tools)
  - [`mlir-opt`](#mlir-opt)
  - [`mlir-translate`](#mlir-translate)
  - [`mlir-reduce`](#mlir-reduce)
  - [`mlir-pdll`](#mlir-pdll)
  - [`mlir-lsp-server`](#mlir-lsp-server)
- [C.11 Clang Tools](#c11-clang-tools)
  - [`clang-format`](#clang-format)
  - [`clang-tidy`](#clang-tidy)
  - [`clangd`](#clangd)
  - [`scan-build` / `scan-view`](#scan-build-scan-view)
  - [`clang-query`](#clang-query)
  - [`clang-refactor`](#clang-refactor)
- [C.12 Debugging: LLDB](#c12-debugging-lldb)
- [C.13 Sanitizer Environment Variables](#c13-sanitizer-environment-variables)
  - [`ASAN_OPTIONS`](#asanoptions)
  - [`TSAN_OPTIONS`](#tsanoptions)
  - [`MSAN_OPTIONS`](#msanoptions)
