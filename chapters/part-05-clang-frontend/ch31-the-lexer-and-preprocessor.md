...
- [31.1 Lexer Architecture](#311-lexer-architecture)
  - [31.1.1 The `clang::Lexer` Class](#3111-the-clanglexer-class)
  - [31.1.2 Raw Lexer Mode vs Preprocessor-Driven Mode](#3112-raw-lexer-mode-vs-preprocessor-driven-mode)
  - [31.1.3 `LangOptions` Governing Lexer Behavior](#3113-langoptions-governing-lexer-behavior)
  - [31.1.4 `Lexer::Lex(Token&)` — The Main Entry Point](#3114-lexerlextoken-the-main-entry-point)
  - [31.1.5 `getSpelling()` and the Scratch Buffer](#3115-getspelling-and-the-scratch-buffer)
  - [31.1.6 Static Utilities: Source-Level Queries](#3116-static-utilities-source-level-queries)
- [31.2 The `Token` Struct](#312-the-token-struct)
  - [31.2.1 Fields](#3121-fields)
  - [31.2.2 `tok::TokenKind` Enumeration](#3122-toktokenkind-enumeration)
  - [31.2.3 `TokenFlags` Bitmask](#3123-tokenflags-bitmask)
  - [31.2.4 Querying Tokens](#3124-querying-tokens)
- [31.3 `IdentifierInfo` and `IdentifierTable`](#313-identifierinfo-and-identifiertable)
  - [31.3.1 The String Intern Table](#3131-the-string-intern-table)
  - [31.3.2 `IdentifierInfo` Fields](#3132-identifierinfo-fields)
  - [31.3.3 Keyword Recognition Sequence](#3133-keyword-recognition-sequence)
  - [31.3.4 `revertTokenIDToIdentifier()`](#3134-reverttokenidtoidentifier)
- [31.4 Character Encoding and Universal Characters](#314-character-encoding-and-universal-characters)
  - [31.4.1 UTF-8 Source Files](#3141-utf-8-source-files)
  - [31.4.2 Universal Character Names](#3142-universal-character-names)
  - [31.4.3 Named UCNs (C23/C++23)](#3143-named-ucns-c23c23)
  - [31.4.4 Line Splicing and Trigraphs](#3144-line-splicing-and-trigraphs)
- [31.5 Literal Lexing](#315-literal-lexing)
  - [31.5.1 Integer Literals: `NumericLiteralParser`](#3151-integer-literals-numericliteralparser)
  - [31.5.2 Floating-Point Literals](#3152-floating-point-literals)
  - [31.5.3 String Literals: `StringLiteralParser`](#3153-string-literals-stringliteralparser)
  - [31.5.4 Character Literals: `CharLiteralParser`](#3154-character-literals-charliteralparser)
  - [31.5.5 User-Defined Literals](#3155-user-defined-literals)
- [31.6 The `Preprocessor` Class](#316-the-preprocessor-class)
  - [31.6.1 Overview](#3161-overview)
  - [31.6.2 The Include/Macro Stack](#3162-the-includemacro-stack)
  - [31.6.3 `Preprocessor::Lex(Token&)` — The Token Pump](#3163-preprocessorlextoken-the-token-pump)
  - [31.6.4 `EnterSourceFile()`, `EnterMacro()`, `EnterTokenStream()`](#3164-entersourcefile-entermacro-entertokenstream)
  - [31.6.5 `LexUnexpandedToken()` and `LexNonComment()`](#3165-lexunexpandedtoken-and-lexnoncomment)
- [31.7 Macro Expansion](#317-macro-expansion)
  - [31.7.1 `MacroInfo` and `MacroDirective`](#3171-macroinfo-and-macrodirective)
  - [31.7.2 Object-Like Macro Expansion](#3172-object-like-macro-expansion)
  - [31.7.3 Function-Like Macro Expansion](#3173-function-like-macro-expansion)
  - [31.7.4 Token Pasting (`##`)](#3174-token-pasting)
  - [31.7.5 Stringification (`#`)](#3175-stringification)
  - [31.7.6 `__VA_ARGS__` and `__VA_OPT__`](#3176-vaargs-and-vaopt)
  - [31.7.7 Built-In Macros](#3177-built-in-macros)
- [31.8 Directive Processing](#318-directive-processing)
  - [31.8.1 `Preprocessor::HandleDirective()`](#3181-preprocessorhandledirective)
  - [31.8.2 `#include` and `HeaderSearch`](#3182-include-and-headersearch)
  - [31.8.3 `HandleDefineDirective()`](#3183-handledefinedirective)
  - [31.8.4 `#undef`, `#line`, and `#error`](#3184-undef-line-and-error)
  - [31.8.5 `#embed` (C23)](#3185-embed-c23)
- [31.9 Conditional Compilation](#319-conditional-compilation)
  - [31.9.1 The Conditional Stack](#3191-the-conditional-stack)
  - [31.9.2 `SkipExcludedConditionalBlock()`](#3192-skipexcludedconditionalblock)
  - [31.9.3 `#if` Expression Evaluation](#3193-if-expression-evaluation)
- [31.10 Pragma Handling](#3110-pragma-handling)
  - [31.10.1 `PragmaHandler`](#31101-pragmahandler)
  - [31.10.2 Built-In Pragma Handlers](#31102-built-in-pragma-handlers)
  - [31.10.3 `_Pragma` Operator](#31103-pragma-operator)
  - [31.10.4 Writing a Custom Pragma Handler Plugin](#31104-writing-a-custom-pragma-handler-plugin)
- [31.11 Precompiled Headers and Modules at the PP Level](#3111-precompiled-headers-and-modules-at-the-pp-level)
  - [31.11.1 `ExternalPreprocessorSource`](#31111-externalpreprocessorsource)
  - [31.11.2 Precompiled Headers](#31112-precompiled-headers)
  - [31.11.3 C++ Named Modules](#31113-c-named-modules)
  - [31.11.4 `#pragma clang module import`](#31114-pragma-clang-module-import)
- [31.12 `PPCallbacks` — Observing the Preprocessor](#3112-ppcallbacks-observing-the-preprocessor)
  - [31.12.1 The `PPCallbacks` Interface](#31121-the-ppcallbacks-interface)
  - [31.12.2 Registration](#31122-registration)
  - [31.12.3 Applications](#31123-applications)
- [31.13 The `clang -E` Pipeline](#3113-the-clang-e-pipeline)
  - [31.13.1 `PrintPreprocessedOutput`](#31131-printpreprocessedoutput)
  - [31.13.2 Linemarker Format](#31132-linemarker-format)
  - [31.13.3 Macro Dump Flags](#31133-macro-dump-flags)
  - [31.13.4 Interaction with `TokenWriter`](#31134-interaction-with-tokenwriter)
- [Summary](#summary)
