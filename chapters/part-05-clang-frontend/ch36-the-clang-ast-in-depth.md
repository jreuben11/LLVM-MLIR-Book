...
- [36.1 AST Philosophy: Staying Close to the Source](#361-ast-philosophy-staying-close-to-the-source)
- [36.2 `ASTContext`: The Allocator and Type-Uniquing Table](#362-astcontext-the-allocator-and-type-uniquing-table)
  - [36.2.1 Arena Allocation](#3621-arena-allocation)
  - [36.2.2 Type Uniquing](#3622-type-uniquing)
  - [36.2.3 Canonical Types](#3623-canonical-types)
  - [36.2.4 Size, Alignment, and Layout](#3624-size-alignment-and-layout)
  - [36.2.5 Root of the Decl Tree](#3625-root-of-the-decl-tree)
- [36.3 The `Decl` Hierarchy](#363-the-decl-hierarchy)
  - [36.3.1 `Decl` Base](#3631-decl-base)
  - [36.3.2 `NamedDecl` and `ValueDecl`](#3632-nameddecl-and-valuedecl)
  - [36.3.3 `VarDecl` and `FieldDecl`](#3633-vardecl-and-fielddecl)
  - [36.3.4 `FunctionDecl`](#3634-functiondecl)
  - [36.3.5 CXX Method Hierarchy](#3635-cxx-method-hierarchy)
  - [36.3.6 `TagDecl`, `RecordDecl`, `CXXRecordDecl`, `EnumDecl`](#3636-tagdecl-recorddecl-cxxrecorddecl-enumdecl)
  - [36.3.7 Other Notable Decl Classes](#3637-other-notable-decl-classes)
- [36.4 The `Type` Hierarchy and `QualType`](#364-the-type-hierarchy-and-qualtype)
  - [36.4.1 `QualType`](#3641-qualtype)
  - [36.4.2 The `Type` Base Class and `TypeClass` Enum](#3642-the-type-base-class-and-typeclass-enum)
  - [36.4.3 Common Type Query Methods](#3643-common-type-query-methods)
  - [36.4.4 `FunctionProtoType`](#3644-functionprototype)
- [36.5 The `Stmt` and `Expr` Hierarchy](#365-the-stmt-and-expr-hierarchy)
  - [36.5.1 `Stmt` Base](#3651-stmt-base)
  - [36.5.2 Statement Classes](#3652-statement-classes)
  - [36.5.3 `Expr` Base](#3653-expr-base)
  - [36.5.4 Literal Expressions](#3654-literal-expressions)
  - [36.5.5 Reference and Member Expressions](#3655-reference-and-member-expressions)
  - [36.5.6 Call Expressions](#3656-call-expressions)
  - [36.5.7 Arithmetic and Logical Expressions](#3657-arithmetic-and-logical-expressions)
  - [36.5.8 Cast Expressions](#3658-cast-expressions)
  - [36.5.9 C++ Expression Nodes](#3659-c-expression-nodes)
- [36.6 Value Categories and the Expression Value-Kind System](#366-value-categories-and-the-expression-value-kind-system)
  - [36.6.1 `ExprValueKind` and `ExprObjectKind`](#3661-exprvaluekind-and-exprobjectkind)
  - [36.6.2 The lvalue-to-rvalue Conversion](#3662-the-lvalue-to-rvalue-conversion)
  - [36.6.3 xvalues and `std::move`](#3663-xvalues-and-stdmove)
  - [36.6.4 `OK_BitField` and Non-Ordinary Object Kinds](#3664-okbitfield-and-non-ordinary-object-kinds)
- [36.7 `RecursiveASTVisitor`](#367-recursiveastvisitor)
  - [36.7.1 Class Structure](#3671-class-structure)
  - [36.7.2 Writing a Visitor](#3672-writing-a-visitor)
  - [36.7.3 Controlling Traversal](#3673-controlling-traversal)
- [36.8 `ASTConsumer` and `FrontendAction`](#368-astconsumer-and-frontendaction)
  - [36.8.1 `ASTConsumer`](#3681-astconsumer)
  - [36.8.2 `FrontendAction`](#3682-frontendaction)
  - [36.8.3 `ASTUnit`](#3683-astunit)
  - [36.8.4 `ClangTool` and Compilation Databases](#3684-clangtool-and-compilation-databases)
- [36.9 The `ASTMatcher` Library](#369-the-astmatcher-library)
  - [36.9.1 Matcher Types](#3691-matcher-types)
  - [36.9.2 `MatchFinder` and Callbacks](#3692-matchfinder-and-callbacks)
  - [36.9.3 Composing Complex Queries](#3693-composing-complex-queries)
- [36.10 Implicit AST Nodes](#3610-implicit-ast-nodes)
  - [36.10.1 Implicit Special Member Functions](#36101-implicit-special-member-functions)
  - [36.10.2 `ImplicitCastExpr` Nodes](#36102-implicitcastexpr-nodes)
  - [36.10.3 `CXXDefaultArgExpr`](#36103-cxxdefaultargexpr)
  - [36.10.4 `MaterializeTemporaryExpr` and `ExprWithCleanups`](#36104-materializetemporaryexpr-and-exprwithcleanups)
- [36.11 Debugging and Dumping the AST](#3611-debugging-and-dumping-the-ast)
  - [36.11.1 Command-Line Dumps](#36111-command-line-dumps)
  - [36.11.2 Programmatic Dumps](#36112-programmatic-dumps)
  - [36.11.3 `clang-query`](#36113-clang-query)
  - [36.11.4 Reducing AST Noise](#36114-reducing-ast-noise)
- [36.12 Source Locations in the AST](#3612-source-locations-in-the-ast)
  - [36.12.1 `Decl` Locations](#36121-decl-locations)
  - [36.12.2 `Stmt` and `Expr` Locations](#36122-stmt-and-expr-locations)
  - [36.12.3 Extending Ranges](#36123-extending-ranges)
  - [36.12.4 Macro Expansion Locations](#36124-macro-expansion-locations)
  - [36.12.5 Source Locations and Rewriting](#36125-source-locations-and-rewriting)
