...
- [Template Representation in the AST](#template-representation-in-the-ast)
  - [The TemplateDecl Hierarchy](#the-templatedecl-hierarchy)
  - [TemplateParameterList and Parameter Kinds](#templateparameterlist-and-parameter-kinds)
  - [TemplateArgument — The Discriminated Union](#templateargument-the-discriminated-union)
- [Template Parsing and Declaration](#template-parsing-and-declaration)
  - [ParseTemplateDeclaration](#parsetemplatedeclaration)
  - [Member Templates and Local Classes](#member-templates-and-local-classes)
- [Template Instantiation — Core Mechanism](#template-instantiation-core-mechanism)
  - [The Instantiation Entry Points](#the-instantiation-entry-points)
  - [MultiLevelTemplateArgumentList](#multileveltemplateargumentlist)
  - [InstantiatingTemplate RAII Guard and the CodeSynthesisContext Stack](#instantiatingtemplate-raii-guard-and-the-codesynthesiscontext-stack)
- [Template Argument Deduction](#template-argument-deduction)
  - [DeduceTemplateArguments for Function Templates](#deducetemplatearguments-for-function-templates)
  - [TemplateDeductionResult](#templatedeductionresult)
  - [TemplateDeductionInfo](#templatedeductioninfo)
  - [Class Template Argument Deduction (CTAD, C++17)](#class-template-argument-deduction-ctad-c17)
  - [Class Template Argument Deduction — Deduction Guides](#class-template-argument-deduction-deduction-guides)
  - [Partial Ordering of Function Templates](#partial-ordering-of-function-templates)
- [Substitution and SFINAE](#substitution-and-sfinae)
  - [The Substitution Entry Points](#the-substitution-entry-points)
  - [SFINAE Mechanics](#sfinae-mechanics)
- [Explicit and Partial Specializations](#explicit-and-partial-specializations)
  - [ClassTemplateSpecializationDecl](#classtemplatespecializationdecl)
  - [Specialization Registration](#specialization-registration)
  - [Explicit Instantiation](#explicit-instantiation)
- [Variadic Templates](#variadic-templates)
  - [Parameter Pack Representation](#parameter-pack-representation)
  - [Pack Expansion Checking](#pack-expansion-checking)
  - [Fold Expressions (C++17)](#fold-expressions-c17)
  - [Pack Indexing (C++26)](#pack-indexing-c26)
- [Concepts and Constraints (C++20)](#concepts-and-constraints-c20)
  - [ConceptDecl](#conceptdecl)
  - [ConceptSpecializationExpr](#conceptspecializationexpr)
  - [RequiresExpr](#requiresexpr)
- [Constraint Satisfaction Checking](#constraint-satisfaction-checking)
  - [CheckConstraintSatisfaction](#checkconstraintsatisfaction)
  - [EnsureTemplateArgumentListConstraints](#ensuretemplateargumentlistconstraints)
- [Constraint Normalization and Subsumption](#constraint-normalization-and-subsumption)
  - [NormalizedConstraint](#normalizedconstraint)
  - [IsAtLeastAsConstrained / Subsumption](#isatleastasconstrained-subsumption)
- [requires-Clauses and Associated Constraints](#requires-clauses-and-associated-constraints)
  - [Associated Constraints](#associated-constraints)
  - [Abbreviated Function Templates](#abbreviated-function-templates)
  - [Interaction with Implicit Member Synthesis](#interaction-with-implicit-member-synthesis)
- [Template Instantiation Internals — TreeTransform](#template-instantiation-internals-treetransform)
  - [TreeTransform<Derived>](#treetransformderived)
  - [Type Specialization Representations](#type-specialization-representations)
  - [LocalInstantiationScope](#localinstantiationscope)
- [Lazy Instantiation and Deferred Diagnostics](#lazy-instantiation-and-deferred-diagnostics)
  - [The PendingInstantiations Queue](#the-pendinginstantiations-queue)
  - [Deferred Access Checking](#deferred-access-checking)
  - [Lambda Captures in Templates](#lambda-captures-in-templates)
- [Friend Templates and Dependent Names](#friend-templates-and-dependent-names)
  - [FriendDecl with Templates](#frienddecl-with-templates)
  - [Dependent Name Representation](#dependent-name-representation)
  - [The `typename` Disambiguator](#the-typename-disambiguator)
  - [Two-Phase Name Lookup](#two-phase-name-lookup)
- [Diagnostic Notes and Developer Patterns](#diagnostic-notes-and-developer-patterns)
  - [Reading Template Backtraces](#reading-template-backtraces)
  - [Examining Specializations Programmatically](#examining-specializations-programmatically)
  - [Triggering Constraint Checking in a Tool](#triggering-constraint-checking-in-a-tool)
