...
- [30.1 Architecture: Three-Component Decoupling](#301-architecture-three-component-decoupling)
  - [30.1.1 `DiagnosticStorage` and the Allocator](#3011-diagnosticstorage-and-the-allocator)
- [30.2 `DiagnosticIDs` and the Metadata Database](#302-diagnosticids-and-the-metadata-database)
  - [30.2.1 Generated Numeric IDs](#3021-generated-numeric-ids)
  - [30.2.2 Diagnostic Classes](#3022-diagnostic-classes)
- [30.3 Diagnostic Groups and `-W` Flags](#303-diagnostic-groups-and-w-flags)
  - [30.3.1 Group Definitions](#3031-group-definitions)
  - [30.3.2 Severity Manipulation](#3032-severity-manipulation)
- [30.4 Emitting a Diagnostic: The `DiagnosticBuilder` RAII Pattern](#304-emitting-a-diagnostic-the-diagnosticbuilder-raii-pattern)
  - [30.4.1 The `Report()` + `<<` Pattern](#3041-the-report-pattern)
  - [30.4.2 Inside `ProcessDiag()`](#3042-inside-processdiag)
  - [30.4.3 Format String Syntax](#3043-format-string-syntax)
  - [30.4.4 `PartialDiagnostic`: Deferred Argument Capture](#3044-partialdiagnostic-deferred-argument-capture)
  - [30.4.5 `SemaDiagnosticBuilder` and GPU Deferred Diagnostics](#3045-semadiagnosticbuilder-and-gpu-deferred-diagnostics)
- [30.5 `DiagnosticConsumer` Implementations](#305-diagnosticconsumer-implementations)
  - [30.5.1 `TextDiagnosticPrinter`](#3051-textdiagnosticprinter)
  - [30.5.2 `TextDiagnosticBuffer`](#3052-textdiagnosticbuffer)
  - [30.5.3 `IgnoringDiagConsumer`](#3053-ignoringdiagconsumer)
  - [30.5.4 `ForwardingDiagnosticConsumer`](#3054-forwardingdiagnosticconsumer)
  - [30.5.5 `LogDiagnosticPrinter`](#3055-logdiagnosticprinter)
  - [30.5.6 `SARIFDiagnosticPrinter`](#3056-sarifdiagnosticprinter)
  - [30.5.7 Writing a Custom Consumer](#3057-writing-a-custom-consumer)
- [30.6 Fix-It Hints](#306-fix-it-hints)
  - [30.6.1 Parseable Fix-Its (`-fdiagnostics-parseable-fixits`)](#3061-parseable-fix-its-fdiagnostics-parseable-fixits)
  - [30.6.2 `FixItRewriter` for In-Place Application](#3062-fixitrewriter-for-in-place-application)
- [30.7 Notes and Continuation Diagnostics](#307-notes-and-continuation-diagnostics)
  - [30.7.1 Note Semantics](#3071-note-semantics)
  - [30.7.2 Chaining Multiple Notes](#3072-chaining-multiple-notes)
- [30.8 Diagnostic State and Suppression](#308-diagnostic-state-and-suppression)
  - [30.8.1 The `DiagState` and `DiagStateMap`](#3081-the-diagstate-and-diagstatemap)
  - [30.8.2 `#pragma clang diagnostic`](#3082-pragma-clang-diagnostic)
  - [30.8.3 `DiagnosticMapping` Internals](#3083-diagnosticmapping-internals)
  - [30.8.4 Diagnostic Suppression Mapping Files](#3084-diagnostic-suppression-mapping-files)
  - [30.8.5 Per-Diagnostic and Error-Limit Controls](#3085-per-diagnostic-and-error-limit-controls)
  - [30.8.6 `DiagnosticErrorTrap`](#3086-diagnosticerrortrap)
- [30.9 Source Ranges, Carets, and Terminal Rendering](#309-source-ranges-carets-and-terminal-rendering)
  - [30.9.1 `DiagnosticRenderer` Architecture](#3091-diagnosticrenderer-architecture)
  - [30.9.2 Caret Placement](#3092-caret-placement)
  - [30.9.3 Macro Expansion Rendering](#3093-macro-expansion-rendering)
  - [30.9.4 Display Flags](#3094-display-flags)
- [30.10 Structured Diagnostics and Tooling Integration](#3010-structured-diagnostics-and-tooling-integration)
  - [30.10.1 Serialized Diagnostics (`.dia` Files)](#30101-serialized-diagnostics-dia-files)
  - [30.10.2 `VerifyDiagnosticConsumer` for Testing](#30102-verifydiagnosticconsumer-for-testing)
  - [30.10.3 libclang `CXDiagnostic` API](#30103-libclang-cxdiagnostic-api)
  - [30.10.4 clangd Integration](#30104-clangd-integration)
- [30.11 Custom Diagnostic IDs](#3011-custom-diagnostic-ids)
  - [30.11.1 `getCustomDiagID()`](#30111-getcustomdiagid)
  - [30.11.2 clang-tidy Pattern](#30112-clang-tidy-pattern)
- [30.12 Diagnostics in the Compiler Pipeline](#3012-diagnostics-in-the-compiler-pipeline)
  - [30.12.1 Error Gatekeeping](#30121-error-gatekeeping)
  - [30.12.2 PCH Diagnostic State Replay](#30122-pch-diagnostic-state-replay)
  - [30.12.3 `DiagnosticsEngine::Reset()`](#30123-diagnosticsenginereset)
  - [30.12.4 Deferrable Diagnostics in Offloading](#30124-deferrable-diagnostics-in-offloading)
  - [30.12.5 SFINAE Interaction](#30125-sfinae-interaction)
