...
- [35.1 Why Constant Evaluation Exists in the Compiler](#351-why-constant-evaluation-exists-in-the-compiler)
- [35.2 Entry Points on `Expr`](#352-entry-points-on-expr)
  - [35.2.1 `EvalStatus` and `EvalResult`](#3521-evalstatus-and-evalresult)
  - [35.2.2 `SideEffectsKind`](#3522-sideeffectskind)
  - [35.2.3 `EvaluateAsRValue` and Typed Variants](#3523-evaluateasrvalue-and-typed-variants)
  - [35.2.4 `EvaluateAsConstantExpr`](#3524-evaluateasconstantexpr)
  - [35.2.5 `isPotentialConstantExpr`](#3525-ispotentialconstantexpr)
  - [35.2.6 ICE Checking and `Sema::VerifyIntegerConstantExpression`](#3526-ice-checking-and-semaverifyintegerconstantexpression)
  - [35.2.7 `VarDecl::evaluateValue`](#3527-vardeclevaluatevalue)
- [35.3 `APValue` — The Constant Value Representation](#353-apvalue-the-constant-value-representation)
  - [35.3.1 `ValueKind` Enum](#3531-valuekind-enum)
  - [35.3.2 `APValue::LValueBase`](#3532-apvaluelvaluebase)
  - [35.3.3 `LValuePathEntry` and Designators](#3533-lvaluepathentry-and-designators)
  - [35.3.4 Struct, Array, and Union APValues](#3534-struct-array-and-union-apvalues)
- [35.4 `EvalInfo` — Evaluation Context and State](#354-evalinfo-evaluation-context-and-state)
  - [35.4.1 `EvaluationMode`](#3541-evaluationmode)
  - [35.4.2 `CallStackFrame`](#3542-callstackframe)
  - [35.4.3 `EvalInfo::setEvaluatingDecl`](#3543-evalinfosetevaluatingdecl)
  - [35.4.4 `noteFailure` and `SpeculativeEvaluationRAII`](#3544-notefailure-and-speculativeevaluationraii)
  - [35.4.5 The `InConstantContext` Flag and `IgnoreSideEffectsRAII`](#3545-the-inconstantcontext-flag-and-ignoresideeffectsraii)
  - [35.4.6 Diagnostic Emission: `FFDiag`, `CCEDiag`, and `Note`](#3546-diagnostic-emission-ffdiag-ccediag-and-note)
- [35.5 Integer Constant Expression Evaluation](#355-integer-constant-expression-evaluation)
  - [35.5.1 The `ExprEvaluatorBase` CRTP Base](#3551-the-exprevaluatorbase-crtp-base)
  - [35.5.2 Binary Operator Handling and Overflow](#3552-binary-operator-handling-and-overflow)
  - [35.5.3 `sizeof` and `alignof`](#3553-sizeof-and-alignof)
  - [35.5.4 Conditional Operators, Comma Operators, and Short-Circuit Evaluation](#3554-conditional-operators-comma-operators-and-short-circuit-evaluation)
  - [35.5.5 Cast Handling: `HandleIntToIntCast` and `HandleFloatToIntCast`](#3555-cast-handling-handleinttointcast-and-handlefloattointcast)
  - [35.5.6 `OffsetOfExpr`](#3556-offsetofexpr)
- [35.6 `constexpr` Function Evaluation](#356-constexpr-function-evaluation)
  - [35.6.1 `HandleFunctionCall`](#3561-handlefunctioncall)
  - [35.6.2 Constructor and Destructor Calls](#3562-constructor-and-destructor-calls)
  - [35.6.3 Local State and Mutation](#3563-local-state-and-mutation)
  - [35.6.4 `consteval` and Immediate Invocations](#3564-consteval-and-immediate-invocations)
  - [35.6.5 C++14 Multi-Statement Bodies](#3565-c14-multi-statement-bodies)
  - [35.6.6 Dynamic Memory Allocation in `constexpr` (C++20)](#3566-dynamic-memory-allocation-in-constexpr-c20)
- [35.7 LValue Evaluation and Pointer Arithmetic](#357-lvalue-evaluation-and-pointer-arithmetic)
  - [35.7.1 `LValueExprEvaluator`](#3571-lvalueexprevaluator)
  - [35.7.2 One-Past-The-End Pointer Legality](#3572-one-past-the-end-pointer-legality)
  - [35.7.3 Pointer Arithmetic: `HandleLValueArrayAdjustment`](#3573-pointer-arithmetic-handlelvaluearrayadjustment)
  - [35.7.4 `CheckLValueConstantExpression`](#3574-checklvalueconstantexpression)
  - [35.7.5 `std::is_constant_evaluated` / `__builtin_is_constant_evaluated`](#3575-stdisconstantevaluated-builtinisconstantevaluated)
- [35.8 Floating-Point Constant Evaluation](#358-floating-point-constant-evaluation)
  - [35.8.1 `FloatExprEvaluator`](#3581-floatexprevaluator)
  - [35.8.2 Cast Handling](#3582-cast-handling)
  - [35.8.3 `__builtin_*` Math Functions in `constexpr`](#3583-builtin-math-functions-in-constexpr)
  - [35.8.4 `-ffast-math` Is Never Applied in `constexpr` Contexts](#3584-ffast-math-is-never-applied-in-constexpr-contexts)
- [35.9 Aggregate and Composite Initialization](#359-aggregate-and-composite-initialization)
  - [35.9.1 `ArrayExprEvaluator`](#3591-arrayexprevaluator)
  - [35.9.2 `RecordExprEvaluator`](#3592-recordexprevaluator)
  - [35.9.3 `std::array` and Standard Library Types](#3593-stdarray-and-standard-library-types)
  - [35.9.4 Designated Initializers (C99 / C++20)](#3594-designated-initializers-c99-c20)
- [35.10 `static_assert` and Concept Constraint Satisfaction](#3510-staticassert-and-concept-constraint-satisfaction)
  - [35.10.1 `static_assert` Evaluation](#35101-staticassert-evaluation)
  - [35.10.2 `CheckConstraintSatisfaction`](#35102-checkconstraintsatisfaction)
- [35.11 `__builtin_*` Constant Evaluation](#3511-builtin-constant-evaluation)
  - [35.11.1 `__builtin_constant_p`](#35111-builtinconstantp)
  - [35.11.2 `__builtin_bit_cast`](#35112-builtinbitcast)
  - [35.11.3 `__builtin_memcpy`, `__builtin_memmove`, `__builtin_memcmp`](#35113-builtinmemcpy-builtinmemmove-builtinmemcmp)
  - [35.11.4 `__builtin_strlen` and `__builtin_strcmp`](#35114-builtinstrlen-and-builtinstrcmp)
  - [35.11.5 `__builtin_add_overflow`, `__builtin_sub_overflow`, `__builtin_mul_overflow`](#35115-builtinaddoverflow-builtinsuboverflow-builtinmuloverflow)
  - [35.11.6 `__builtin_expect` and `__builtin_unreachable`](#35116-builtinexpect-and-builtinunreachable)
  - [35.11.7 `__builtin_popcount`, `__builtin_clz`, `__builtin_ctz`](#35117-builtinpopcount-builtinclz-builtinctz)
- [35.12 Calling the Evaluator from a Clang Tool](#3512-calling-the-evaluator-from-a-clang-tool)
- [35.13 Diagnosing Non-Constant Expressions](#3513-diagnosing-non-constant-expressions)
  - [35.13.1 `EvalStatus::HasSideEffects` and `HasUndefinedBehavior`](#35131-evalstatushassideeffects-and-hasundefinedbehavior)
  - [35.13.2 C++20 Behaviors That Were Previously Silent](#35132-c20-behaviors-that-were-previously-silent)
- [35.14 The `ConstantExpr` AST Node](#3514-the-constantexpr-ast-node)
