...
- [38.1 The Code-Completion Token and Parser Integration](#381-the-code-completion-token-and-parser-integration)
  - [38.1.1 How Completion Is Triggered](#3811-how-completion-is-triggered)
  - [38.1.2 Parser Dispatch to Sema Completion Methods](#3812-parser-dispatch-to-sema-completion-methods)
  - [38.1.3 `SemaCodeCompletion`'s Internal `ResultBuilder`](#3813-semacodecompletions-internal-resultbuilder)
  - [38.1.4 The `PrintingCodeCompleteConsumer`](#3814-the-printingcodecompleteconsumer)
- [38.2 `CodeCompletionResult` and the Result Data Model](#382-codecompletionresult-and-the-result-data-model)
  - [38.2.1 `ResultKind` Enumeration](#3821-resultkind-enumeration)
  - [38.2.2 Priority Scoring](#3822-priority-scoring)
  - [38.2.3 Availability](#3823-availability)
  - [38.2.4 `CodeCompletionString` and Its Chunks](#3824-codecompletionstring-and-its-chunks)
  - [38.2.5 `CodeCompletionAllocator` and `CodeCompletionBuilder`](#3825-codecompletionallocator-and-codecompletionbuilder)
- [38.3 Completion Contexts](#383-completion-contexts)
  - [38.3.1 `CodeCompletionContext::Kind`](#3831-codecompletioncontextkind)
  - [38.3.2 Mapping Parser State to Context](#3832-mapping-parser-state-to-context)
  - [38.3.3 Fix-It Completions](#3833-fix-it-completions)
- [38.4 Preamble Compilation](#384-preamble-compilation)
  - [38.4.1 What the Preamble Is](#3841-what-the-preamble-is)
  - [38.4.2 `PrecompiledPreamble::Build()`](#3842-precompiledpreamblebuild)
  - [38.4.3 Reuse Validation and `AddImplicitPreamble()`](#3843-reuse-validation-and-addimplicitpreamble)
- [38.5 clangd Architecture Overview](#385-clangd-architecture-overview)
  - [38.5.1 clangd as an LSP Server](#3851-clangd-as-an-lsp-server)
  - [38.5.2 The Layered Architecture](#3852-the-layered-architecture)
- [38.6 `TUScheduler` and Asynchronous Compilation](#386-tuscheduler-and-asynchronous-compilation)
  - [38.6.1 Per-File `ASTWorker` Threads](#3861-per-file-astworker-threads)
  - [38.6.2 Debouncing and Rebuild Scheduling](#3862-debouncing-and-rebuild-scheduling)
  - [38.6.3 `ASTRetentionPolicy` and Memory Management](#3863-astretentionpolicy-and-memory-management)
  - [38.6.4 `ASTActionInvalidation` and Request Cancellation](#3864-astactioninvalidation-and-request-cancellation)
- [38.7 `ParsedAST`](#387-parsedast)
  - [38.7.1 `ParsedAST::build()`](#3871-parsedastbuild)
  - [38.7.2 Contents of `ParsedAST`](#3872-contents-of-parsedast)
- [38.8 Symbol Index](#388-symbol-index)
  - [38.8.1 `SymbolIndex` Interface](#3881-symbolindex-interface)
  - [38.8.2 `MemIndex` and `DexIndex`](#3882-memindex-and-dexindex)
  - [38.8.3 `FileIndex` and the Dynamic/Static Split](#3883-fileindex-and-the-dynamicstatic-split)
- [38.9 Hover, Go-to-Definition, and Find-References](#389-hover-go-to-definition-and-find-references)
  - [38.9.1 Hover via `getHover()`](#3891-hover-via-gethover)
  - [38.9.2 Go-to-Definition via `locateSymbolAt()`](#3892-go-to-definition-via-locatesymbolat)
  - [38.9.3 Find-References via `findReferences()`](#3893-find-references-via-findreferences)
- [38.10 Diagnostics and Fixes in clangd](#3810-diagnostics-and-fixes-in-clangd)
  - [38.10.1 `StoreDiags`](#38101-storediags)
  - [38.10.2 `ClangdDiagnosticOptions`](#38102-clangddiagnosticoptions)
  - [38.10.3 clang-tidy Integration](#38103-clang-tidy-integration)
- [38.11 Semantic Tokens](#3811-semantic-tokens)
  - [38.11.1 `getSemanticHighlightings()`](#38111-getsemantichighlightings)
  - [38.11.2 `HighlightingKind` and `HighlightingModifier`](#38112-highlightingkind-and-highlightingmodifier)
  - [38.11.3 Token Resolution and LSP Encoding](#38113-token-resolution-and-lsp-encoding)
- [38.12 Compilation Database](#3812-compilation-database)
  - [38.12.1 `CompilationDatabase` Interface](#38121-compilationdatabase-interface)
  - [38.12.2 Concrete Implementations](#38122-concrete-implementations)
  - [38.12.3 `GlobalCompilationDatabase` in clangd](#38123-globalcompilationdatabase-in-clangd)
  - [38.12.4 `clang-scan-deps` and Modular Databases](#38124-clang-scan-deps-and-modular-databases)
- [38.13 The LSP Message Flow: A Complete Example](#3813-the-lsp-message-flow-a-complete-example)
- [38.14 Code Completion Ranking and Quality Scoring](#3814-code-completion-ranking-and-quality-scoring)
  - [38.14.1 Heuristic vs. Learned Ranking](#38141-heuristic-vs-learned-ranking)
  - [38.14.2 Decision Forest and Feature Encoding](#38142-decision-forest-and-feature-encoding)
  - [38.14.3 Header Insertion](#38143-header-insertion)
