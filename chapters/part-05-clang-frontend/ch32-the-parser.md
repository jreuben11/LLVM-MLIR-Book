...
- [32.1 Parser Architecture](#321-parser-architecture)
  - [32.1.1 The `clang::Parser` Class](#3211-the-clangparser-class)
  - [32.1.2 The `Actions` Member and the Sema Contract](#3212-the-actions-member-and-the-sema-contract)
  - [32.1.3 `ParseAST()` — The Entry Point](#3213-parseast-the-entry-point)
  - [32.1.4 `ParseTopLevelDecl()` and the Translation Unit Loop](#3214-parsetopleveldecl-and-the-translation-unit-loop)
  - [32.1.5 `ParseScope` — RAII Scope Management](#3215-parsescope-raii-scope-management)
- [32.2 Token Management](#322-token-management)
  - [32.2.1 The Lookahead Token](#3221-the-lookahead-token)
  - [32.2.2 Consumption Methods](#3222-consumption-methods)
  - [32.2.3 Conditional Consumption](#3223-conditional-consumption)
  - [32.2.4 `ExpectAndConsume` and `ExpectAndConsumeSemi`](#3224-expectandconsume-and-expectandconsumesemi)
  - [32.2.5 Annotation Tokens](#3225-annotation-tokens)
- [32.3 Tentative Parsing and Disambiguation](#323-tentative-parsing-and-disambiguation)
  - [32.3.1 The C++ Ambiguity Problem](#3231-the-c-ambiguity-problem)
  - [32.3.2 `TentativeParsingAction`](#3232-tentativeparsingaction)
  - [32.3.3 The `TPResult` Enum and Disambiguation Functions](#3233-the-tpresult-enum-and-disambiguation-functions)
  - [32.3.4 Resolution Rules](#3234-resolution-rules)
- [32.4 Annotation Tokens and Name Resolution](#324-annotation-tokens-and-name-resolution)
  - [32.4.1 The `TryAnnotateName` Family](#3241-the-tryannotatename-family)
  - [32.4.2 Annotation Token Kinds](#3242-annotation-token-kinds)
- [32.5 Declarations and Declarators](#325-declarations-and-declarators)
  - [32.5.1 `DeclSpec` — Accumulating Type Specifiers](#3251-declspec-accumulating-type-specifiers)
  - [32.5.2 `Declarator` and `DeclaratorChunk`](#3252-declarator-and-declaratorchunk)
  - [32.5.3 Function Declarator Parsing](#3253-function-declarator-parsing)
  - [32.5.4 `ParseDeclGroup()` — Init-Declarator Lists](#3254-parsedeclgroup-init-declarator-lists)
  - [32.5.5 `ParsingDeclSpec` and `ParsingDeclarator` RAII Wrappers](#3255-parsingdeclspec-and-parsingdeclarator-raii-wrappers)
- [32.6 Expression Parsing](#326-expression-parsing)
  - [32.6.1 Precedence Climbing](#3261-precedence-climbing)
  - [32.6.2 Cast and Postfix Expressions](#3262-cast-and-postfix-expressions)
  - [32.6.3 Constant Expressions](#3263-constant-expressions)
  - [32.6.4 `ParseParenExpression` — The Type/Expression Crossroads](#3264-parseparenexpression-the-typeexpression-crossroads)
  - [32.6.5 Built-In Primary Expressions](#3265-built-in-primary-expressions)
  - [32.6.6 Initializer Lists](#3266-initializer-lists)
- [32.7 Statement Parsing](#327-statement-parsing)
  - [32.7.1 `ParseStatement()` Dispatch](#3271-parsestatement-dispatch)
  - [32.7.2 Compound Statements](#3272-compound-statements)
  - [32.7.3 `for` and Range-Based `for`](#3273-for-and-range-based-for)
  - [32.7.4 Coroutine Statements](#3274-coroutine-statements)
- [32.8 Late Parsing of Inline Method Bodies](#328-late-parsing-of-inline-method-bodies)
  - [32.8.1 `LateParsedDeclaration` and `LexedMethod`](#3281-lateparseddeclaration-and-lexedmethod)
  - [32.8.2 `LateParsedDefaultArgument`](#3282-lateparseddefaultargument)
  - [32.8.3 `LateParsedAttribute`](#3283-lateparsedattribute)
- [32.9 C++ Specific Declarations](#329-c-specific-declarations)
  - [32.9.1 Namespaces](#3291-namespaces)
  - [32.9.2 Class and Struct Declarations](#3292-class-and-struct-declarations)
  - [32.9.3 Template Declarations](#3293-template-declarations)
  - [32.9.4 C++20 Modules](#3294-c20-modules)
  - [32.9.5 `using` Declarations and Aliases](#3295-using-declarations-and-aliases)
  - [32.9.6 `static_assert`, Lambda, and Try-Block](#3296-staticassert-lambda-and-try-block)
- [32.10 C++ Specific Type and Expression Constructs](#3210-c-specific-type-and-expression-constructs)
  - [32.10.1 C++ Cast Expressions](#32101-c-cast-expressions)
  - [32.10.2 `new` and `delete`](#32102-new-and-delete)
  - [32.10.3 `if` with Initializer and `ParseCXXCondition`](#32103-if-with-initializer-and-parsecxxcondition)
  - [32.10.4 Structured Bindings](#32104-structured-bindings)
  - [32.10.5 `throw`](#32105-throw)
- [32.11 Attributes](#3211-attributes)
  - [32.11.1 Attribute Dispatch](#32111-attribute-dispatch)
  - [32.11.2 GNU Attributes](#32112-gnu-attributes)
  - [32.11.3 C++11 / C23 Attributes](#32113-c11-c23-attributes)
  - [32.11.4 Microsoft `__declspec`](#32114-microsoft-declspec)
  - [32.11.5 `ParsedAttr` and `ParseAttributeArgsCommon`](#32115-parsedattr-and-parseattributeargscommon)
- [32.12 Pragma Handling](#3212-pragma-handling)
  - [32.12.1 `PragmaHandler` Infrastructure](#32121-pragmahandler-infrastructure)
  - [32.12.2 Pragma Annotation Token Processing](#32122-pragma-annotation-token-processing)
- [32.13 Error Recovery](#3213-error-recovery)
  - [32.13.1 `SkipUntil`](#32131-skipuntil)
  - [32.13.2 `BalancedDelimiterTracker`](#32132-balanceddelimitertracker)
  - [32.13.3 `DiagnosticErrorTrap`](#32133-diagnosticerrortrap)
  - [32.13.4 Semicolon Insertion](#32134-semicolon-insertion)
  - [32.13.5 Typo Correction at Parse Time](#32135-typo-correction-at-parse-time)
  - [32.13.6 Cascading Diagnostic Suppression](#32136-cascading-diagnostic-suppression)
- [32.14 `ParseAST()` and the Full Compilation Pipeline](#3214-parseast-and-the-full-compilation-pipeline)
  - [32.14.1 `FrontendAction` Integration](#32141-frontendaction-integration)
  - [32.14.2 `ASTConsumer` Interface](#32142-astconsumer-interface)
  - [32.14.3 `ActOnEndOfTranslationUnit`](#32143-actonendoftranslationunit)
  - [32.14.4 `SkipFunctionBodies` Mode](#32144-skipfunctionbodies-mode)
- [32.15 Incremental Parsing (clang-repl)](#3215-incremental-parsing-clang-repl)
  - [32.15.1 Architecture](#32151-architecture)
  - [32.15.2 `PartialTranslationUnit`](#32152-partialtranslationunit)
  - [32.15.3 `IncrementalParser` Operation](#32153-incrementalparser-operation)
  - [32.15.4 `Undo` and Symbol Visibility](#32154-undo-and-symbol-visibility)
  - [32.15.5 Value Printing and `ParseAndExecute`](#32155-value-printing-and-parseandexecute)
- [32.16 Code Completion Integration](#3216-code-completion-integration)
  - [32.16.1 `CodeCompletionHandler` Inheritance](#32161-codecompletionhandler-inheritance)
  - [32.16.2 Preferred Type Tracking](#32162-preferred-type-tracking)
