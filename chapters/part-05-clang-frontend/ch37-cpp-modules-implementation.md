...
- [37.1 C++20 Module Grammar and Concepts](#371-c20-module-grammar-and-concepts)
  - [37.1.1 Module Interface Units](#3711-module-interface-units)
  - [37.1.2 Module Implementation Units](#3712-module-implementation-units)
  - [37.1.3 Module Partitions](#3713-module-partitions)
  - [37.1.4 Global Module Fragment](#3714-global-module-fragment)
  - [37.1.5 Private Module Fragment](#3715-private-module-fragment)
  - [37.1.6 The `std` Named Module (C++23)](#3716-the-std-named-module-c23)
  - [37.1.7 Modules vs. Clang Header Modules vs. PCH](#3717-modules-vs-clang-header-modules-vs-pch)
- [37.2 Module File Formats: The BMI](#372-module-file-formats-the-bmi)
  - [37.2.1 Producing a BMI](#3721-producing-a-bmi)
  - [37.2.2 On-Disk Binary Format](#3722-on-disk-binary-format)
  - [37.2.3 The `ModuleFile` Struct](#3723-the-modulefile-struct)
  - [37.2.4 Module Signature and Dependency Checking](#3724-module-signature-and-dependency-checking)
- [37.3 The `Module` Class](#373-the-module-class)
  - [37.3.1 `clang::Module` Identity and Fields](#3731-clangmodule-identity-and-fields)
  - [37.3.2 `ModuleKind` Enum](#3732-modulekind-enum)
  - [37.3.3 Module Membership Queries](#3733-module-membership-queries)
  - [37.3.4 Module Initialization and Runtime Support](#3734-module-initialization-and-runtime-support)
- [37.4 Module Map Files: The Older Header Module System](#374-module-map-files-the-older-header-module-system)
  - [37.4.1 `module.modulemap` Syntax](#3741-modulemodulemap-syntax)
  - [37.4.2 `ModuleMap` Class](#3742-modulemap-class)
  - [37.4.3 VFS Overlay and Darwin SDK Modules](#3743-vfs-overlay-and-darwin-sdk-modules)
- [37.5 `HeaderSearch` and Import Processing](#375-headersearch-and-import-processing)
  - [37.5.1 `HeaderFileInfo`](#3751-headerfileinfo)
  - [37.5.2 Processing `import` Directives](#3752-processing-import-directives)
  - [37.5.3 `ModuleLoader` Interface](#3753-moduleloader-interface)
  - [37.5.4 Token-Level Import Handling in the Preprocessor](#3754-token-level-import-handling-in-the-preprocessor)
- [37.6 Compiling Module Interface Units](#376-compiling-module-interface-units)
  - [37.6.1 Driver and cc1 Flags](#3761-driver-and-cc1-flags)
  - [37.6.2 Parsing the Module Interface](#3762-parsing-the-module-interface)
  - [37.6.3 `ExportDecl` and Export Semantics](#3763-exportdecl-and-export-semantics)
  - [37.6.4 Header Unit Compilation](#3764-header-unit-compilation)
  - [37.6.5 End-of-Translation-Unit Actions](#3765-end-of-translation-unit-actions)
- [37.7 `ASTWriter` and `ASTReader`](#377-astwriter-and-astreader)
  - [37.7.1 `ASTWriter` Architecture](#3771-astwriter-architecture)
  - [37.7.2 Deferred Declaration Queue](#3772-deferred-declaration-queue)
  - [37.7.3 `ASTReader` Architecture](#3773-astreader-architecture)
  - [37.7.4 `GlobalDeclID` and `LocalDeclID` Remapping](#3774-globaldeclid-and-localdeclid-remapping)
  - [37.7.5 Reading Types and Declarations](#3775-reading-types-and-declarations)
  - [37.7.6 Merging Declarations Across Modules](#3776-merging-declarations-across-modules)
- [37.8 Name Visibility and Reachability](#378-name-visibility-and-reachability)
  - [37.8.1 The Module Ownership Model](#3781-the-module-ownership-model)
  - [37.8.2 Visible vs. Reachable](#3782-visible-vs-reachable)
  - [37.8.3 `VisibleModules` and Transitive Visibility](#3783-visiblemodules-and-transitive-visibility)
  - [37.8.4 ADL Across Module Boundaries](#3784-adl-across-module-boundaries)
  - [37.8.5 Inline Functions and Owning Modules](#3785-inline-functions-and-owning-modules)
  - [37.8.6 `friend` Declarations Across Modules](#3786-friend-declarations-across-modules)
- [37.9 Global Module Fragment and `extern "C"` Interaction](#379-global-module-fragment-and-extern-c-interaction)
  - [37.9.1 Header Units vs. Text Includes](#3791-header-units-vs-text-includes)
  - [37.9.2 `extern "C"` and Module Attachment](#3792-extern-c-and-module-attachment)
  - [37.9.3 Interaction with Implicit Modules and `-fimplicit-modules`](#3793-interaction-with-implicit-modules-and-fimplicit-modules)
- [37.10 Incremental Builds and Dependency Scanning](#3710-incremental-builds-and-dependency-scanning)
  - [37.10.1 `clang-scan-deps` and P1689](#37101-clang-scan-deps-and-p1689)
  - [37.10.2 `DependencyScanningTool` API](#37102-dependencyscanningtool-api)
  - [37.10.3 CMake 3.28 and Ninja 1.11 Integration](#37103-cmake-328-and-ninja-111-integration)
  - [37.10.4 `-fprebuilt-module-path` and Explicit Module Files](#37104-fprebuilt-module-path-and-explicit-module-files)
- [37.11 Clang Header Modules: The Older System](#3711-clang-header-modules-the-older-system)
  - [37.11.1 `-fmodules` Mode](#37111-fmodules-mode)
  - [37.11.2 PCM Validation](#37112-pcm-validation)
  - [37.11.3 Darwin SDK Modules and `-fapinotes`](#37113-darwin-sdk-modules-and-fapinotes)
  - [37.11.4 Migration Path to C++20 Named Modules](#37114-migration-path-to-c20-named-modules)
- [37.12 Practical Issues and Diagnostics](#3712-practical-issues-and-diagnostics)
  - [37.12.1 Import Ordering Restrictions](#37121-import-ordering-restrictions)
  - [37.12.2 Partition Visibility Constraints](#37122-partition-visibility-constraints)
  - [37.12.3 Private Module Fragment Rules](#37123-private-module-fragment-rules)
  - [37.12.4 Deferred Instantiation Across Module Boundaries](#37124-deferred-instantiation-across-module-boundaries)
  - [37.12.5 `[[clang::internal_linkage]]` and Module Boundaries](#37125-clanginternallinkage-and-module-boundaries)
  - [37.12.6 Known Limitations in Clang 22](#37126-known-limitations-in-clang-22)
