...
- [10.1 Mathematical Foundations: Partial Orders and Lattices](#101-mathematical-foundations-partial-orders-and-lattices)
  - [10.1.1 Partial Orders](#1011-partial-orders)
  - [10.1.2 Lattices](#1012-lattices)
  - [10.1.3 Complete Lattices](#1013-complete-lattices)
  - [10.1.3.1 Why Completeness Matters](#10131-why-completeness-matters)
  - [10.1.4 Height of a Lattice and Chain Conditions](#1014-height-of-a-lattice-and-chain-conditions)
- [10.2 Tarski's Fixed-Point Theorem](#102-tarskis-fixed-point-theorem)
  - [10.2.1 Statement and Proof](#1021-statement-and-proof)
  - [10.2.2 Proof of the Greatest Fixed Point](#1022-proof-of-the-greatest-fixed-point)
  - [10.2.3 Consequence for Dataflow](#1023-consequence-for-dataflow)
- [10.3 Kleene Iteration and the Worklist Algorithm](#103-kleene-iteration-and-the-worklist-algorithm)
  - [10.3.1 Kleene's Ascending Chain Theorem](#1031-kleenes-ascending-chain-theorem)
  - [10.3.2 The Round-Robin Iterative Algorithm](#1032-the-round-robin-iterative-algorithm)
  - [10.3.3 The Worklist Algorithm](#1033-the-worklist-algorithm)
  - [10.3.4 Bit-Vector Implementations](#1034-bit-vector-implementations)
  - [10.3.5 SSA and Dataflow](#1035-ssa-and-dataflow)
- [10.4 Monotone vs. Distributive Frameworks and MOP vs. MFP](#104-monotone-vs-distributive-frameworks-and-mop-vs-mfp)
  - [10.4.1 Monotone Frameworks](#1041-monotone-frameworks)
  - [10.4.2 Distributive Frameworks](#1042-distributive-frameworks)
  - [10.4.3 The MOP Solution and Why MFP ≤ MOP](#1043-the-mop-solution-and-why-mfp-mop)
  - [10.4.4 A Taxonomy of Classical Analyses](#1044-a-taxonomy-of-classical-analyses)
  - [10.4.5 Composing Analyses: The Cartesian Product Construction](#1045-composing-analyses-the-cartesian-product-construction)
- [10.5 Transfer Functions: Gen/Kill and Beyond](#105-transfer-functions-genkill-and-beyond)
  - [10.5.1 The Gen/Kill Form](#1051-the-genkill-form)
  - [10.5.2 Forward vs. Backward Analyses](#1052-forward-vs-backward-analyses)
  - [10.5.3 Computing Gen/Kill for Common Instruction Types](#1053-computing-genkill-for-common-instruction-types)
- [10.6 Classical Analyses](#106-classical-analyses)
  - [10.6.1 Liveness Analysis](#1061-liveness-analysis)
  - [10.6.2 Available Expressions](#1062-available-expressions)
  - [10.6.3 Reaching Definitions](#1063-reaching-definitions)
  - [10.6.4 Very Busy Expressions](#1064-very-busy-expressions)
  - [10.6.5 Constant Propagation](#1065-constant-propagation)
- [10.7 Abstract Interpretation: Widening, Narrowing, and Galois Connections](#107-abstract-interpretation-widening-narrowing-and-galois-connections)
  - [10.7.1 The Problem of Infinite-Height Lattices](#1071-the-problem-of-infinite-height-lattices)
  - [10.7.2 Abstract Interpretation and Galois Connections](#1072-abstract-interpretation-and-galois-connections)
  - [10.7.3 Widening](#1073-widening)
  - [10.7.4 Narrowing](#1074-narrowing)
  - [10.7.5 The Interval Domain in Detail](#1075-the-interval-domain-in-detail)
  - [10.7.6 Connection to LLVM](#1076-connection-to-llvm)
- [10.8 Interprocedural Extensions](#108-interprocedural-extensions)
  - [10.8.1 The Interprocedural Challenge](#1081-the-interprocedural-challenge)
  - [10.8.2 Context-Insensitive Analysis (k=0 CFA)](#1082-context-insensitive-analysis-k0-cfa)
  - [10.8.3 Call Strings and k-CFA](#1083-call-strings-and-k-cfa)
  - [10.8.4 Summary-Based Analysis (Functional Approach)](#1084-summary-based-analysis-functional-approach)
  - [10.8.5 The IFDS Framework: Interprocedural Finite Distributive Subset Problems](#1085-the-ifds-framework-interprocedural-finite-distributive-subset-problems)
  - [10.8.6 Demand-Driven and Compositional Analysis](#1086-demand-driven-and-compositional-analysis)
- [10.9 Connection to LLVM's Analysis Infrastructure](#109-connection-to-llvms-analysis-infrastructure)
  - [10.9.1 The New Pass Manager and Analysis Results](#1091-the-new-pass-manager-and-analysis-results)
  - [10.9.2 Key Analysis Implementations](#1092-key-analysis-implementations)
  - [10.9.3 The AnalysisManager as a Lattice Fixed-Point Cache](#1093-the-analysismanager-as-a-lattice-fixed-point-cache)
  - [10.9.4 Implementing a Custom Dataflow Analysis in LLVM](#1094-implementing-a-custom-dataflow-analysis-in-llvm)
  - [10.9.5 Performance Characteristics of LLVM's Dataflow Analyses](#1095-performance-characteristics-of-llvms-dataflow-analyses)
- [10.10 Correctness, Precision, and the Soundness/Completeness Tradeoff](#1010-correctness-precision-and-the-soundnesscompleteness-tradeoff)
  - [10.10.1 Soundness of Dataflow Analyses](#10101-soundness-of-dataflow-analyses)
  - [10.10.2 Completeness](#10102-completeness)
  - [10.10.3 Verification of Analysis Implementations](#10103-verification-of-analysis-implementations)
- [10.11 Chapter Summary](#1011-chapter-summary)
