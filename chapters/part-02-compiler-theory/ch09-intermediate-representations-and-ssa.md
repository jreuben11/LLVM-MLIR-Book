...
- [9.1 Why an IR? The N×M Problem and IR Properties](#91-why-an-ir-the-nm-problem-and-ir-properties)
  - [9.1.1 The multi-pass compilation model](#911-the-multi-pass-compilation-model)
  - [9.1.2 The N×M problem](#912-the-nm-problem)
  - [9.1.3 Properties of a good IR](#913-properties-of-a-good-ir)
  - [9.1.4 Historical IRs](#914-historical-irs)
- [9.2 IR Taxonomy: AST, Three-Address Code, CPS, ANF, SSA](#92-ir-taxonomy-ast-three-address-code-cps-anf-ssa)
  - [9.2.1 Abstract Syntax Tree](#921-abstract-syntax-tree)
  - [9.2.2 Three-Address Code](#922-three-address-code)
  - [9.2.3 Continuation-Passing Style](#923-continuation-passing-style)
  - [9.2.4 Administrative Normal Form](#924-administrative-normal-form)
  - [9.2.5 Static Single Assignment Form](#925-static-single-assignment-form)
- [9.3 The SSA Invariant: Formal Definition and Intuition](#93-the-ssa-invariant-formal-definition-and-intuition)
  - [9.3.1 Formal definition](#931-formal-definition)
  - [9.3.2 The dominance condition and strict SSA](#932-the-dominance-condition-and-strict-ssa)
  - [9.3.3 Static vs. dynamic assignment](#933-static-vs-dynamic-assignment)
  - [9.3.4 Use-def and def-use chains in SSA](#934-use-def-and-def-use-chains-in-ssa)
- [9.4 Dominator Trees and Dominance Frontiers](#94-dominator-trees-and-dominance-frontiers)
  - [9.4.1 Dominators and the dominator tree](#941-dominators-and-the-dominator-tree)
  - [9.4.2 Computing dominator trees](#942-computing-dominator-trees)
  - [9.4.3 Dominance frontiers](#943-dominance-frontiers)
- [9.5 The Cytron Algorithm: IDF, φ-Placement, and Renaming](#95-the-cytron-algorithm-idf-placement-and-renaming)
  - [9.5.1 Why DF is not enough: the need for IDF](#951-why-df-is-not-enough-the-need-for-idf)
  - [9.5.2 φ-function placement](#952-function-placement)
  - [9.5.3 Variable renaming](#953-variable-renaming)
- [9.6 Worked Example: SSA Construction for a Loop CFG](#96-worked-example-ssa-construction-for-a-loop-cfg)
  - [9.6.1 The control-flow graph](#961-the-control-flow-graph)
  - [9.6.2 Step 1: Dominator tree](#962-step-1-dominator-tree)
  - [9.6.3 Step 2: Dominance frontiers](#963-step-2-dominance-frontiers)
  - [9.6.4 Step 3: IDF computation and φ-placement](#964-step-3-idf-computation-and-placement)
  - [9.6.5 Step 4: Variable renaming](#965-step-4-variable-renaming)
  - [9.6.6 Final SSA form](#966-final-ssa-form)
- [9.7 Pruned, Minimal, and Semi-Pruned SSA](#97-pruned-minimal-and-semi-pruned-ssa)
  - [9.7.1 Minimal SSA](#971-minimal-ssa)
  - [9.7.2 Pruned SSA](#972-pruned-ssa)
  - [9.7.3 Semi-pruned SSA](#973-semi-pruned-ssa)
  - [9.7.4 Comparison](#974-comparison)
- [9.8 Out-of-SSA Conversion: Lost-Copy, Swap, and Correct Algorithms](#98-out-of-ssa-conversion-lost-copy-swap-and-correct-algorithms)
  - [9.8.1 The naive approach and its correctness](#981-the-naive-approach-and-its-correctness)
  - [9.8.2 The lost-copy problem](#982-the-lost-copy-problem)
  - [9.8.3 The swap problem](#983-the-swap-problem)
  - [9.8.4 The Briggs–Cooper–Harvey–Reeves sequentialisation algorithm](#984-the-briggscooperharveyreeves-sequentialisation-algorithm)
  - [9.8.5 Sreedhar's Method III: congruence class merging](#985-sreedhars-method-iii-congruence-class-merging)
- [9.9 CPS ↔ SSA Equivalence](#99-cps-ssa-equivalence)
  - [9.9.1 Appel's observation](#991-appels-observation)
  - [9.9.2 The formal mapping on our worked example](#992-the-formal-mapping-on-our-worked-example)
  - [9.9.3 Implications of the isomorphism](#993-implications-of-the-isomorphism)
  - [9.9.4 MLIR's block arguments as explicit CPS](#994-mlirs-block-arguments-as-explicit-cps)
- [9.10 Connection to LLVM IR and MLIR](#910-connection-to-llvm-ir-and-mlir)
  - [9.10.1 LLVM IR as infinite-register SSA](#9101-llvm-ir-as-infinite-register-ssa)
  - [9.10.2 The alloca+mem2reg strategy in Clang](#9102-the-allocamem2reg-strategy-in-clang)
  - [9.10.3 The LLVM dominance infrastructure](#9103-the-llvm-dominance-infrastructure)
  - [9.10.4 SSA in the LLVM optimisation pipeline](#9104-ssa-in-the-llvm-optimisation-pipeline)
  - [9.10.5 MLIR's SSA semantics and regions](#9105-mlirs-ssa-semantics-and-regions)
- [9.11 Chapter Summary](#911-chapter-summary)
