...
- [11.1 Local vs. Global vs. Interprocedural: The Optimization Scope](#111-local-vs-global-vs-interprocedural-the-optimization-scope)
  - [11.1.1 Local optimizations](#1111-local-optimizations)
  - [11.1.2 Global optimizations](#1112-global-optimizations)
  - [11.1.3 Interprocedural optimizations](#1113-interprocedural-optimizations)
  - [11.1.4 Why pipeline order matters](#1114-why-pipeline-order-matters)
  - [11.1.5 The fixed-point iteration approach](#1115-the-fixed-point-iteration-approach)
- [11.2 Common Subexpression Elimination: Value Numbering and GVN](#112-common-subexpression-elimination-value-numbering-and-gvn)
  - [11.2.1 Local value numbering](#1121-local-value-numbering)
  - [11.2.2 Global value numbering in SSA form](#1122-global-value-numbering-in-ssa-form)
  - [11.2.3 SuperGVN and LLVM's NewGVN](#1123-supergvn-and-llvms-newgvn)
- [11.3 Loop-Invariant Code Motion](#113-loop-invariant-code-motion)
  - [11.3.1 Loop-invariant expressions](#1131-loop-invariant-expressions)
  - [11.3.2 Code hoisting](#1132-code-hoisting)
  - [11.3.3 The LICM algorithm](#1133-the-licm-algorithm)
  - [11.3.4 LLVM's LICM pass](#1134-llvms-licm-pass)
- [11.4 Strength Reduction and Induction Variables](#114-strength-reduction-and-induction-variables)
  - [11.4.1 Induction variables and families](#1141-induction-variables-and-families)
  - [11.4.2 Strength reduction](#1142-strength-reduction)
  - [11.4.3 Induction variable simplification](#1143-induction-variable-simplification)
  - [11.4.4 ScalarEvolution in LLVM](#1144-scalarevolution-in-llvm)
- [11.5 Partial Redundancy Elimination and Lazy Code Motion](#115-partial-redundancy-elimination-and-lazy-code-motion)
  - [11.5.1 Partial vs. full redundancy](#1151-partial-vs-full-redundancy)
  - [11.5.2 Morel-Renvoise PRE](#1152-morel-renvoise-pre)
  - [11.5.3 Lazy Code Motion](#1153-lazy-code-motion)
  - [11.5.4 GVN-PRE in LLVM](#1154-gvn-pre-in-llvm)
- [11.6 Register Allocation: Graph Coloring Theory](#116-register-allocation-graph-coloring-theory)
  - [11.6.1 The interference graph](#1161-the-interference-graph)
  - [11.6.2 Graph coloring is NP-complete](#1162-graph-coloring-is-np-complete)
  - [11.6.3 Chaitin's algorithm](#1163-chaitins-algorithm)
  - [11.6.4 Chaitin-Briggs improvements](#1164-chaitin-briggs-improvements)
  - [11.6.5 Iterated Register Coalescing (George-Appel)](#1165-iterated-register-coalescing-george-appel)
  - [11.6.6 Worked example: interference graph and coloring](#1166-worked-example-interference-graph-and-coloring)
- [11.7 Linear Scan and PBQP Register Allocation](#117-linear-scan-and-pbqp-register-allocation)
  - [11.7.1 Linear scan register allocation](#1171-linear-scan-register-allocation)
  - [11.7.2 PBQP register allocation](#1172-pbqp-register-allocation)
  - [11.7.3 SSA-based register allocation](#1173-ssa-based-register-allocation)
- [11.8 Instruction Scheduling](#118-instruction-scheduling)
  - [11.8.1 The scheduling problem](#1181-the-scheduling-problem)
  - [11.8.2 The dependence DAG](#1182-the-dependence-dag)
  - [11.8.3 List scheduling](#1183-list-scheduling)
  - [11.8.4 Trace scheduling](#1184-trace-scheduling)
  - [11.8.5 Software pipelining and modulo scheduling](#1185-software-pipelining-and-modulo-scheduling)
- [11.9 Garbage Collection Theory](#119-garbage-collection-theory)
  - [11.9.1 Mark-Sweep](#1191-mark-sweep)
  - [11.9.2 Copying Collection (Cheney)](#1192-copying-collection-cheney)
  - [11.9.3 Generational GC](#1193-generational-gc)
  - [11.9.4 Incremental and concurrent GC](#1194-incremental-and-concurrent-gc)
  - [11.9.5 Region-based memory management](#1195-region-based-memory-management)
  - [11.9.6 Compiler support for GC](#1196-compiler-support-for-gc)
- [11.10 LLVM Implementations](#1110-llvm-implementations)
  - [11.10.1 GVN and NewGVN](#11101-gvn-and-newgvn)
  - [11.10.2 LICM](#11102-licm)
  - [11.10.3 IndVarSimplify and ScalarEvolution](#11103-indvarsimplify-and-scalarevolution)
  - [11.10.4 The Greedy Register Allocator](#11104-the-greedy-register-allocator)
  - [11.10.5 Linear Scan (RegAllocFast)](#11105-linear-scan-regallocfast)
  - [11.10.6 MachinePipeliner (SMS)](#11106-machinepipeliner-sms)
  - [11.10.7 GC statepoints](#11107-gc-statepoints)
  - [11.10.8 The LLVM optimization pipeline overview](#11108-the-llvm-optimization-pipeline-overview)
- [11.11 Putting It All Together: A Worked Compilation Pipeline](#1111-putting-it-all-together-a-worked-compilation-pipeline)
- [11.12 Chapter Summary](#1112-chapter-summary)
