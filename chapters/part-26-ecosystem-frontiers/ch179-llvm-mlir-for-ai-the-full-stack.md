...
- [179.1 The AI Compilation Hierarchy](#1791-the-ai-compilation-hierarchy)
  - [179.1.1 The Four Levels](#17911-the-four-levels)
  - [179.1.2 The Handoff Protocols](#17912-the-handoff-protocols)
  - [179.1.3 Architecture: Framework to Target](#17913-architecture-framework-to-target)
- [179.2 The MLIR Dialect Tower for AI](#1792-the-mlir-dialect-tower-for-ai)
  - [179.2.1 Level Roles and the Bufferisation Boundary](#17921-level-roles-and-the-bufferisation-boundary)
  - [179.2.2 `linalg.generic` as Universal Abstraction](#17922-linalggeneric-as-universal-abstraction)
  - [179.2.3 `vector` as the SIMD Bridge](#17923-vector-as-the-simd-bridge)
- [179.3 Quantization: Dialects, Formats, and Lowering](#1793-quantization-dialects-formats-and-lowering)
  - [179.3.1 The `quant` Dialect](#17931-the-quant-dialect)
  - [179.3.2 Precision Formats](#17932-precision-formats)
  - [179.3.3 GPTQ and Post-Training Weight Quantisation](#17933-gptq-and-post-training-weight-quantisation)
  - [179.3.4 GGUF: File Format for Quantised LLMs](#17934-gguf-file-format-for-quantised-llms)
  - [179.3.5 The StableHLO Quantization Path](#17935-the-stablehlo-quantization-path)
- [179.4 Dynamic Shapes](#1794-dynamic-shapes)
  - [179.4.1 The Cost of Static Shapes](#17941-the-cost-of-static-shapes)
  - [179.4.2 StableHLO Dynamic Shape Extensions](#17942-stablehlo-dynamic-shape-extensions)
  - [179.4.3 The `shape` Dialect](#17943-the-shape-dialect)
  - [179.4.4 `tensor.dim` and Dynamic Tensor Operations](#17944-tensordim-and-dynamic-tensor-operations)
  - [179.4.5 IREE's Dynamic Dispatch](#17945-irees-dynamic-dispatch)
  - [179.4.6 torch.export with Dynamic Shapes](#17946-torchexport-with-dynamic-shapes)
- [179.5 Hardware Target Landscape](#1795-hardware-target-landscape)
  - [179.5.1 CUDA / NVPTX](#17951-cuda-nvptx)
  - [179.5.2 ROCm / AMDGPU](#17952-rocm-amdgpu)
  - [179.5.3 Apple ANE (Neural Engine)](#17953-apple-ane-neural-engine)
  - [179.5.4 Qualcomm Hexagon DSP and QNN](#17954-qualcomm-hexagon-dsp-and-qnn)
  - [179.5.5 Edge TPU and Embedded NPUs](#17955-edge-tpu-and-embedded-npus)
- [179.6 Inference Deployment Stack](#1796-inference-deployment-stack)
  - [179.6.1 IREE](#17961-iree)
  - [179.6.2 TFLite](#17962-tflite)
  - [179.6.3 ONNX Runtime](#17963-onnx-runtime)
  - [179.6.4 TensorRT](#17964-tensorrt)
  - [179.6.5 Decision Matrix](#17965-decision-matrix)
- [179.7 Training vs Inference Compilation](#1797-training-vs-inference-compilation)
  - [179.7.1 Inference: Latency and Throughput](#17971-inference-latency-and-throughput)
  - [179.7.2 Training: Gradient Correctness and Memory](#17972-training-gradient-correctness-and-memory)
  - [179.7.3 Mixed Precision and BF16](#17973-mixed-precision-and-bf16)
  - [179.7.4 Distributed Training: SPMD Sharding](#17974-distributed-training-spmd-sharding)
- [179.8 Kernel Fusion: FlashAttention as Case Study](#1798-kernel-fusion-flashattention-as-case-study)
  - [179.8.1 The Fusion Problem in Attention](#17981-the-fusion-problem-in-attention)
  - [179.8.2 FlashAttention 2 Algorithm](#17982-flashattention-2-algorithm)
  - [179.8.3 FlashAttention 3 on Hopper](#17983-flashattention-3-on-hopper)
  - [179.8.4 The MLIR Lowering Path for Fused Attention](#17984-the-mlir-lowering-path-for-fused-attention)
  - [179.8.5 What MLIR Enables vs What It Does Not (Yet)](#17985-what-mlir-enables-vs-what-it-does-not-yet)
- [179.9 End-to-End Traced Walkthrough: Linear Layer to PTX](#1799-end-to-end-traced-walkthrough-linear-layer-to-ptx)
  - [Step 1 — `torch.export` → `ExportedProgram`](#step-1-torchexport-exportedprogram)
  - [Step 2 — torch-mlir → `stablehlo.dot_general` + `stablehlo.add`](#step-2-torch-mlir-stablehlodotgeneral-stablehloadd)
  - [Step 3 — StableHLO → `linalg.matmul` + `linalg.map`](#step-3-stablehlo-linalgmatmul-linalgmap)
  - [Step 4 — Tiling via Transform Dialect](#step-4-tiling-via-transform-dialect)
  - [Step 5 — Vectorisation → `vector.contract`](#step-5-vectorisation-vectorcontract)
  - [Step 6 — One-Shot Bufferization → `memref`](#step-6-one-shot-bufferization-memref)
  - [Step 7 — `nvvm` Dialect → PTX](#step-7-nvvm-dialect-ptx)
