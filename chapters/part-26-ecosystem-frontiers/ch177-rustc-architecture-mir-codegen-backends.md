...
- [177.1 rustc Architecture Overview](#1771-rustc-architecture-overview)
  - [Driver Phases](#driver-phases)
  - [HIR and THIR in Detail](#hir-and-thir-in-detail)
  - [The Query System](#the-query-system)
  - [Dependency Tracking and `DepNode`](#dependency-tracking-and-depnode)
  - [`TyCtxt`, `Ty<'tcx>`, and the Type Arena](#tyctxt-tytcx-and-the-type-arena)
- [177.2 MIR: Rust's Mid-Level IR](#1772-mir-rusts-mid-level-ir)
  - [Core Data Types](#core-data-types)
  - [MIR CFG and Basic Blocks](#mir-cfg-and-basic-blocks)
  - [MIR in Practice: A Dump](#mir-in-practice-a-dump)
  - [Non-Lexical Lifetimes (NLL)](#non-lexical-lifetimes-nll)
  - [The `mir::Body` Structure in Full](#the-mirbody-structure-in-full)
  - [MIR Phases](#mir-phases)
  - [MIR Optimization Passes](#mir-optimization-passes)
  - [Monomorphization](#monomorphization)
- [177.3 Miri: The MIR Interpreter](#1773-miri-the-mir-interpreter)
  - [Architecture: `InterpCx<MiriMachine>`](#architecture-interpcxmirimachine)
  - [What Miri Detects](#what-miri-detects)
  - [Stacked Borrows Memory Model](#stacked-borrows-memory-model)
  - [Tree Borrows](#tree-borrows)
  - [Using Miri](#using-miri)
  - [Miri vs Sanitizers: Complementary Coverage](#miri-vs-sanitizers-complementary-coverage)
  - [Const Evaluation: `InterpCx` Without `MiriMachine`](#const-evaluation-interpcx-without-mirimachine)
- [177.4 Polonius: The New Borrow Checker](#1774-polonius-the-new-borrow-checker)
  - [The Datalog Formulation](#the-datalog-formulation)
  - [Solving Strategies](#solving-strategies)
  - [Activating Polonius](#activating-polonius)
  - [NLL Constraint Solving in Detail](#nll-constraint-solving-in-detail)
  - [The `use<>` Precise Capture Syntax (Edition 2024)](#the-use-precise-capture-syntax-edition-2024)
- [177.5 a-mir-formality: The Formal Model](#1775-a-mir-formality-the-formal-model)
  - [What It Formalizes](#what-it-formalizes)
  - [Relationship to Chalk and the Next-Gen Trait Solver](#relationship-to-chalk-and-the-next-gen-trait-solver)
  - [Using the Formality](#using-the-formality)
  - [Trait Solver Architecture in Brief](#trait-solver-architecture-in-brief)
- [177.6 rustc_codegen_llvm: MIR → LLVM IR](#1776-rustccodegenllvm-mir-llvm-ir)
  - [Context Hierarchy](#context-hierarchy)
  - [The Translation Loop](#the-translation-loop)
  - [ADT Layout and the `TyAndLayout` Type](#adt-layout-and-the-tyandlayout-type)
  - [Trait Object Fat Pointers](#trait-object-fat-pointers)
  - [Rust-Specific LLVM Attributes](#rust-specific-llvm-attributes)
  - [Drop Glue and `ElaborateDrops`](#drop-glue-and-elaboratedrops)
  - [A Worked Example: `fn max_pair`](#a-worked-example-fn-maxpair)
- [177.7 Panics, Unwinding, and the Personality Function](#1777-panics-unwinding-and-the-personality-function)
  - [`-C panic=unwind` (Default)](#c-panicunwind-default)
  - [`-C panic=abort`](#c-panicabort)
  - [`catch_unwind` and FFI Safety](#catchunwind-and-ffi-safety)
  - [Windows SEH Unwinding](#windows-seh-unwinding)
- [177.8 LTO, PGO, and Cross-Compilation](#1778-lto-pgo-and-cross-compilation)
  - [Link-Time Optimization](#link-time-optimization)
  - [Profile-Guided Optimization](#profile-guided-optimization)
  - [Cross-Compilation](#cross-compilation)
  - [rustc's Vendored LLVM](#rustcs-vendored-llvm)
- [177.9 The Cranelift Backend (rustc_codegen_cranelift)](#1779-the-cranelift-backend-rustccodegencranelift)
  - [CLIF: Cranelift Intermediate Format](#clif-cranelift-intermediate-format)
  - [Compilation Pipeline](#compilation-pipeline)
  - [Cranelift vs LLVM for Debug Builds](#cranelift-vs-llvm-for-debug-builds)
  - [Wasmtime Integration](#wasmtime-integration)
  - [Activating Cranelift in rustc](#activating-cranelift-in-rustc)
  - [Async Closures and Coroutine Lowering (Edition 2024)](#async-closures-and-coroutine-lowering-edition-2024)
- [177.10 The GCC Backend (rustc_codegen_gcc)](#17710-the-gcc-backend-rustccodegengcc)
  - [libgccjit API](#libgccjit-api)
  - [How `rustc_codegen_gcc` Maps to `rustc_codegen_llvm`](#how-rustccodegengcc-maps-to-rustccodegenllvm)
  - [Motivation](#motivation)
  - [Status as of April 2026](#status-as-of-april-2026)
- [177.11 rustc's Vendored LLVM and Version Delta Strategy](#17711-rustcs-vendored-llvm-and-version-delta-strategy)
  - [rustc's LLVM Wrapper Crate](#rustcs-llvm-wrapper-crate)
