...
- [48.1 The CUDA Compilation Model](#481-the-cuda-compilation-model)
  - [48.1.1 Single Source, Two Code Paths](#4811-single-source-two-code-paths)
  - [48.1.2 Key Driver Flags](#4812-key-driver-flags)
  - [48.1.3 CUDA Toolkit Detection](#4813-cuda-toolkit-detection)
- [48.2 CUDA Language Extensions in Clang](#482-cuda-language-extensions-in-clang)
  - [48.2.1 Function Space Qualifiers](#4821-function-space-qualifiers)
  - [48.2.2 Variable Space Qualifiers](#4822-variable-space-qualifiers)
  - [48.2.3 Execution Configuration Syntax](#4823-execution-configuration-syntax)
  - [48.2.4 Launch Bounds](#4824-launch-bounds)
- [48.3 Sema CUDA Handling](#483-sema-cuda-handling)
  - [48.3.1 The SemaCUDA Class](#4831-the-semacuda-class)
  - [48.3.2 Target Identification](#4832-target-identification)
  - [48.3.3 Call Legality and Preferences](#4833-call-legality-and-preferences)
  - [48.3.4 Implicit Host-Device Attributes](#4834-implicit-host-device-attributes)
- [48.4 CodeGen for CUDA](#484-codegen-for-cuda)
  - [48.4.1 CGCUDARuntime and CGNVCUDARuntime](#4841-cgcudaruntime-and-cgnvcudaruntime)
  - [48.4.2 Device Stub Functions](#4842-device-stub-functions)
  - [48.4.3 Module Registration](#4843-module-registration)
- [48.5 Device IR Generation](#485-device-ir-generation)
  - [48.5.1 NVPTX Target Triple and Data Layout](#4851-nvptx-target-triple-and-data-layout)
  - [48.5.2 Thread and Block Index Intrinsics](#4852-thread-and-block-index-intrinsics)
  - [48.5.3 Verified Device IR: SAXPY Kernel](#4853-verified-device-ir-saxpy-kernel)
  - [48.5.4 Shared Memory](#4854-shared-memory)
  - [48.5.5 Constant Memory](#4855-constant-memory)
  - [48.5.6 Barrier and Synchronization](#4856-barrier-and-synchronization)
- [48.6 NVPTX Backend and PTX Generation](#486-nvptx-backend-and-ptx-generation)
  - [48.6.1 NVPTXTargetMachine](#4861-nvptxtargetmachine)
  - [48.6.2 Key NVPTX Passes](#4862-key-nvptx-passes)
  - [48.6.3 PTX Output Structure](#4863-ptx-output-structure)
  - [48.6.4 ptxas and SASS](#4864-ptxas-and-sass)
- [48.7 Fat Binary Creation](#487-fat-binary-creation)
  - [48.7.1 The Fat Binary Format](#4871-the-fat-binary-format)
  - [48.7.2 Embedding in the Host Object](#4872-embedding-in-the-host-object)
  - [48.7.3 Relocatable Device Code and the New Offload Model](#4873-relocatable-device-code-and-the-new-offload-model)
- [48.8 CUDA Intrinsics and Builtins](#488-cuda-intrinsics-and-builtins)
  - [48.8.1 Warp Shuffle Intrinsics](#4881-warp-shuffle-intrinsics)
  - [48.8.2 Vote and Ballot Intrinsics](#4882-vote-and-ballot-intrinsics)
  - [48.8.3 Tensor Core (WMMA) Intrinsics](#4883-tensor-core-wmma-intrinsics)
  - [48.8.4 Read-Only Cache: __ldg](#4884-read-only-cache-ldg)
  - [48.8.5 Half and BFloat16 Types](#4885-half-and-bfloat16-types)
- [48.9 Unified Memory and Address Spaces](#489-unified-memory-and-address-spaces)
  - [48.9.1 NVPTX Address Space Numbering](#4891-nvptx-address-space-numbering)
  - [48.9.2 __managed__ Variables](#4892-managed-variables)
  - [48.9.3 __restrict__ and noalias](#4893-restrict-and-noalias)
- [48.10 Debugging and Profiling Support](#4810-debugging-and-profiling-support)
  - [48.10.1 Host Debug Info](#48101-host-debug-info)
  - [48.10.2 Device Debug Info: -G](#48102-device-debug-info-g)
  - [48.10.3 Lightweight Line Info](#48103-lightweight-line-info)
  - [48.10.4 Register Count Control](#48104-register-count-control)
- [48.11 CUDA in CMake and Build Systems](#4811-cuda-in-cmake-and-build-systems)
  - [48.11.1 CMake CUDA Language Support](#48111-cmake-cuda-language-support)
  - [48.11.2 Mixed-Language Files and Properties](#48112-mixed-language-files-and-properties)
  - [48.11.3 Separate Device Linking](#48113-separate-device-linking)
- [48.12 Differences from nvcc](#4812-differences-from-nvcc)
  - [48.12.1 C++ Standard Compliance](#48121-c-standard-compliance)
  - [48.12.2 Template Instantiation](#48122-template-instantiation)
  - [48.12.3 libdevice.bc Linking](#48123-libdevicebc-linking)
  - [48.12.4 Exception Handling](#48124-exception-handling)
  - [48.12.5 Summary Comparison](#48125-summary-comparison)
