...
- [46.1 The libtooling Execution Framework](#461-the-libtooling-execution-framework)
  - [46.1.1 Core Abstractions](#4611-core-abstractions)
  - [46.1.2 Minimal Tool Template](#4612-minimal-tool-template)
  - [46.1.3 Testing with `runToolOnCode`](#4613-testing-with-runtooloncode)
  - [46.1.4 Flag Injection with `ArgumentsAdjuster`](#4614-flag-injection-with-argumentsadjuster)
- [46.2 The Compilation Database](#462-the-compilation-database)
  - [46.2.1 `CompilationDatabase` and `CompileCommand`](#4621-compilationdatabase-and-compilecommand)
  - [46.2.2 `JSONCompilationDatabase`](#4622-jsoncompilationdatabase)
  - [46.2.3 `FixedCompilationDatabase` and `InterpolatingCompilationDatabase`](#4623-fixedcompilationdatabase-and-interpolatingcompilationdatabase)
  - [46.2.4 `CompilationDatabasePluginRegistry`](#4624-compilationdatabasepluginregistry)
- [46.3 `FrontendAction` and `ASTConsumer`](#463-frontendaction-and-astconsumer)
  - [46.3.1 The Action Hierarchy](#4631-the-action-hierarchy)
  - [46.3.2 `ASTConsumer` Callbacks](#4632-astconsumer-callbacks)
  - [46.3.3 `MultiplexConsumer`](#4633-multiplexconsumer)
- [46.4 `ASTUnit`](#464-astunit)
  - [46.4.1 In-Process Compilation](#4641-in-process-compilation)
  - [46.4.2 Preamble and Incremental Reparse](#4642-preamble-and-incremental-reparse)
  - [46.4.3 Querying `ASTUnit`](#4643-querying-astunit)
- [46.5 The AST Matcher DSL](#465-the-ast-matcher-dsl)
  - [46.5.1 Matcher Types](#4651-matcher-types)
  - [46.5.1a `DynTypedMatcher` and the Dynamic Interface](#4651a-dyntypedmatcher-and-the-dynamic-interface)
  - [46.5.2 Node Matchers](#4652-node-matchers)
  - [46.5.3 Narrowing Matchers](#4653-narrowing-matchers)
  - [46.5.4 Structural (Traversal) Matchers](#4654-structural-traversal-matchers)
  - [46.5.5 Logical Combinators](#4655-logical-combinators)
  - [46.5.6 Binding](#4656-binding)
  - [46.5.7 Matcher Performance Considerations](#4657-matcher-performance-considerations)
- [46.6 `MatchFinder` and `MatchCallback`](#466-matchfinder-and-matchcallback)
  - [46.6.1 Registration and Execution](#4661-registration-and-execution)
  - [46.6.2 A Complete Checker: `printf` Non-Literal Format Strings](#4662-a-complete-checker-printf-non-literal-format-strings)
  - [46.6.3 Lifetime Considerations](#4663-lifetime-considerations)
- [46.7 `Rewriter` and Source Transformations](#467-rewriter-and-source-transformations)
  - [46.7.1 `clang::Rewriter`](#4671-clangrewriter)
  - [46.7.2 `tooling::Replacement` and `tooling::Replacements`](#4672-toolingreplacement-and-toolingreplacements)
  - [46.7.3 `TranslationUnitReplacements` and YAML Export](#4673-translationunitreplacements-and-yaml-export)
  - [46.7.4 `RefactoringTool`](#4674-refactoringtool)
- [46.8 `RecursiveASTVisitor` vs. Matchers](#468-recursiveastvisitor-vs-matchers)
  - [46.8.1 When to Use Each](#4681-when-to-use-each)
  - [46.8.2 `RecursiveASTVisitor` Interface](#4682-recursiveastvisitor-interface)
  - [46.8.3 `WalkUpFrom` vs. `Visit` vs. `Traverse`](#4683-walkupfrom-vs-visit-vs-traverse)
  - [46.8.4 Combining Both Approaches](#4684-combining-both-approaches)
- [46.9 The Refactoring Pipeline](#469-the-refactoring-pipeline)
  - [46.9.1 `clang-apply-replacements`](#4691-clang-apply-replacements)
  - [46.9.2 `clang-rename` as a Worked Example](#4692-clang-rename-as-a-worked-example)
  - [46.9.3 Conflict Detection](#4693-conflict-detection)
- [46.10 Practical Tool Examples](#4610-practical-tool-examples)
  - [46.10.1 Finding TODO Comments with `PPCallbacks`](#46101-finding-todo-comments-with-ppcallbacks)
  - [46.10.2 Include-Guard Checker with `PPCallbacks`](#46102-include-guard-checker-with-ppcallbacks)
  - [46.10.3 Whole-Project Analysis with `AllTUsToolExecutor`](#46103-whole-project-analysis-with-alltustoolexecutor)
- [46.11 `clang-query` REPL](#4611-clang-query-repl)
- [46.12 libclang C API](#4612-libclang-c-api)
  - [46.12.1 Design Philosophy](#46121-design-philosophy)
  - [46.12.2 Core Types](#46122-core-types)
  - [46.12.3 Parsing and Traversal](#46123-parsing-and-traversal)
  - [46.12.4 Code Completion](#46124-code-completion)
  - [46.12.5 libclang vs. libtooling](#46125-libclang-vs-libtooling)
  - [46.12.6 Python `libclang` Bindings](#46126-python-libclang-bindings)
