...
- [47.1 clangd: The LSP Server](#471-clangd-the-lsp-server)
  - [47.1.1 Server Architecture: ClangdLSPServer, ClangdServer, TUScheduler](#4711-server-architecture-clangdlspserver-clangdserver-tuscheduler)
  - [47.1.1b Hover, Go-to-Definition, and Semantic Tokens](#4711b-hover-go-to-definition-and-semantic-tokens)
  - [47.1.2 Inlay Hints](#4712-inlay-hints)
  - [47.1.3 Call Hierarchy and Type Hierarchy](#4713-call-hierarchy-and-type-hierarchy)
  - [47.1.4 Rename](#4714-rename)
  - [47.1.5 Workspace Symbol and BackgroundIndex](#4715-workspace-symbol-and-backgroundindex)
  - [47.1.6 Offline Diagnosis and Remote Index](#4716-offline-diagnosis-and-remote-index)
  - [47.1.7 Completion Engine in clangd](#4717-completion-engine-in-clangd)
- [47.2 clang-tidy: Architecture and Configuration](#472-clang-tidy-architecture-and-configuration)
  - [47.2.1 Core Classes](#4721-core-classes)
  - [47.2.2 Configuration and Options](#4722-configuration-and-options)
  - [47.2.3 Check Module Registration](#4723-check-module-registration)
  - [47.2.4 Execution Pipeline](#4724-execution-pipeline)
- [47.3 Key Check Families](#473-key-check-families)
  - [47.3.1 modernize-\*](#4731-modernize)
  - [47.3.2 readability-\*](#4732-readability)
  - [47.3.3 performance-\*](#4733-performance)
  - [47.3.4 bugprone-\*](#4734-bugprone)
  - [47.3.5 cppcoreguidelines-\* and clang-analyzer-\*](#4735-cppcoreguidelines-and-clang-analyzer)
- [47.4 Writing a clang-tidy Check](#474-writing-a-clang-tidy-check)
  - [47.4.1 Skeleton](#4741-skeleton)
  - [47.4.2 Per-Check Options](#4742-per-check-options)
  - [47.4.3 Testing](#4743-testing)
- [47.5 clang-format: Style Configuration and API](#475-clang-format-style-configuration-and-api)
  - [47.5.1 FormatStyle](#4751-formatstyle)
  - [47.5.2 The Programmatic API](#4752-the-programmatic-api)
  - [47.5.3 Command-Line Usage](#4753-command-line-usage)
  - [47.5.4 Style Inheritance and Custom Styles](#4754-style-inheritance-and-custom-styles)
- [47.6 clang-format Internals](#476-clang-format-internals)
  - [47.6.1 UnwrappedLine and the Parser](#4761-unwrappedline-and-the-parser)
  - [47.6.2 ContinuationIndenter and the Penalty Model](#4762-continuationindenter-and-the-penalty-model)
  - [47.6.3 WhitespaceManager](#4763-whitespacemanager)
  - [47.6.4 Handling Special Constructs](#4764-handling-special-constructs)
- [47.7 clang-refactor](#477-clang-refactor)
  - [47.7.1 Architecture](#4771-architecture)
  - [47.7.2 RefactoringAction and Rules](#4772-refactoringaction-and-rules)
  - [47.7.3 Rename via clangd](#4773-rename-via-clangd)
  - [47.7.4 Extract Function Internals](#4774-extract-function-internals)
- [47.8 include-what-you-use Integration](#478-include-what-you-use-integration)
  - [47.8.1 Architecture](#4781-architecture)
  - [47.8.2 Applying Fixes](#4782-applying-fixes)
- [47.9 pp-trace and clang-check](#479-pp-trace-and-clang-check)
  - [47.9.1 clang-check](#4791-clang-check)
  - [47.9.2 pp-trace](#4792-pp-trace)
  - [47.9.3 clang-extdef-mapping](#4793-clang-extdef-mapping)
- [47.10 Cross-TU Analysis](#4710-cross-tu-analysis)
  - [47.10.1 CrossTranslationUnitContext](#47101-crosstranslationunitcontext)
  - [47.10.2 Integration with the Static Analyzer](#47102-integration-with-the-static-analyzer)
  - [47.10.3 ASTImporter and Merging](#47103-astimporter-and-merging)
- [47.11 Plugin Infrastructure](#4711-plugin-infrastructure)
  - [47.11.1 FrontendPlugin](#47111-frontendplugin)
  - [47.11.2 Attribute Plugins](#47112-attribute-plugins)
  - [47.11.3 Plugin vs. clang-tidy Check](#47113-plugin-vs-clang-tidy-check)
- [47.12 Performance and Large Codebases](#4712-performance-and-large-codebases)
  - [47.12.1 AllTUsToolExecutor and Parallelism](#47121-alltustoolexecutor-and-parallelism)
  - [47.12.2 compile_commands.json Generation](#47122-compilecommandsjson-generation)
