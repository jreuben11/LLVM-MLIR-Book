...
- [51.1 HLSL and the DirectX Compilation Chain](#511-hlsl-and-the-directx-compilation-chain)
  - [51.1.1 Historical Context: FXC, DXC, and Clang](#5111-historical-context-fxc-dxc-and-clang)
  - [51.1.2 Shader Models and Stages](#5112-shader-models-and-stages)
  - [51.1.3 The `clang-dxc` Driver Mode](#5113-the-clang-dxc-driver-mode)
- [51.2 HLSL Language Support in Clang](#512-hlsl-language-support-in-clang)
  - [51.2.1 File Type and Language Options](#5121-file-type-and-language-options)
  - [51.2.2 HLSL-Specific Attribute Family](#5122-hlsl-specific-attribute-family)
  - [51.2.3 Semantic Annotations](#5123-semantic-annotations)
  - [51.2.4 Builtin Types and the External Sema Source](#5124-builtin-types-and-the-external-sema-source)
- [51.3 HLSL Semantic Analysis](#513-hlsl-semantic-analysis)
  - [51.3.1 The `SemaHLSL` Subsystem](#5131-the-semahlsl-subsystem)
  - [51.3.2 Resource Binding Analysis](#5132-resource-binding-analysis)
  - [51.3.3 Root Signature Parsing](#5133-root-signature-parsing)
  - [51.3.4 Intrinsic Functions](#5134-intrinsic-functions)
- [51.4 HLSL CodeGen](#514-hlsl-codegen)
  - [51.4.1 `CGHLSLRuntime` Architecture](#5141-cghlslruntime-architecture)
  - [51.4.2 Resource Handle Lowering](#5142-resource-handle-lowering)
  - [51.4.3 Constant Buffer Lowering](#5143-constant-buffer-lowering)
  - [51.4.4 Entry Point Wrapping](#5144-entry-point-wrapping)
  - [51.4.5 HLSL Built-in Lowering to `dx.op` Calls](#5145-hlsl-built-in-lowering-to-dxop-calls)
- [51.5 The DXIL Target and Backend](#515-the-dxil-target-and-backend)
  - [51.5.1 Target Triple and Machine](#5151-target-triple-and-machine)
  - [51.5.2 DXIL Normalization Passes](#5152-dxil-normalization-passes)
  - [51.5.3 `DXILOpLowering`](#5153-dxiloplowering)
  - [51.5.4 Resource Table Lowering](#5154-resource-table-lowering)
- [51.6 The DX Container Binary Format](#516-the-dx-container-binary-format)
  - [51.6.1 Container Layout](#5161-container-layout)
  - [51.6.2 Container Parts](#5162-container-parts)
  - [51.6.3 The DXIL Bitcode Part](#5163-the-dxil-bitcode-part)
  - [51.6.4 Disassembly and Validation](#5164-disassembly-and-validation)
- [51.7 Resource Binding Model](#517-resource-binding-model)
  - [51.7.1 Register Spaces and Classes](#5171-register-spaces-and-classes)
  - [51.7.2 Resource Kind and Element Type](#5172-resource-kind-and-element-type)
  - [51.7.3 Implicit Binding Assignment](#5173-implicit-binding-assignment)
  - [51.7.4 Root Signature Binding](#5174-root-signature-binding)
- [51.8 Shader Intrinsics and Wave Operations](#518-shader-intrinsics-and-wave-operations)
  - [51.8.1 Wave Intrinsics (SM 6.0+)](#5181-wave-intrinsics-sm-60)
  - [51.8.2 Quad Operations (PS, SM 6.0+)](#5182-quad-operations-ps-sm-60)
  - [51.8.3 Atomic Operations](#5183-atomic-operations)
  - [51.8.4 Inline Raytracing (SM 6.5+)](#5184-inline-raytracing-sm-65)
- [51.9 HLSL and SPIR-V (Vulkan Target)](#519-hlsl-and-spir-v-vulkan-target)
  - [51.9.1 The HLSL → SPIR-V Path](#5191-the-hlsl-spir-v-path)
  - [51.9.2 Vulkan-Specific Binding Annotations](#5192-vulkan-specific-binding-annotations)
  - [51.9.3 Push Constants and Root Constants](#5193-push-constants-and-root-constants)
- [51.10 HLSL in the DirectX 12 / Agility SDK Pipeline](#5110-hlsl-in-the-directx-12-agility-sdk-pipeline)
  - [51.10.1 Runtime Consumption of DXIL](#51101-runtime-consumption-of-dxil)
  - [51.10.2 Shader Reflection](#51102-shader-reflection)
  - [51.10.3 Debug Information](#51103-debug-information)
- [51.11 Toolchain Integration and Testing](#5111-toolchain-integration-and-testing)
  - [51.11.1 Compilation Workflow](#51111-compilation-workflow)
  - [51.11.2 Test Infrastructure](#51112-test-infrastructure)
  - [51.11.3 HLSL 2021 Features](#51113-hlsl-2021-features)
