...
- [1. Origins and Early History](#1-origins-and-early-history)
  - [The Illinois Research Project (2000–2003)](#the-illinois-research-project-20002003)
  - [Why the "Virtual Machine" Name Was Dropped](#why-the-virtual-machine-name-was-dropped)
  - [Apple Adoption and the Move to Industry](#apple-adoption-and-the-move-to-industry)
  - [Open Governance and the LLVM Foundation](#open-governance-and-the-llvm-foundation)
  - [The License Model](#the-license-model)
- [2. The Monorepo Architecture](#2-the-monorepo-architecture)
  - [From Separate Repositories to llvm/llvm-project](#from-separate-repositories-to-llvmllvm-project)
  - [Commit and Review Workflow](#commit-and-review-workflow)
  - [Physical Layout](#physical-layout)
- [3. Subproject Map](#3-subproject-map)
  - [LLVM Core (`llvm/`)](#llvm-core-llvm)
  - [Clang (`clang/`)](#clang-clang)
  - [clang-tools-extra (`clang-tools-extra/`)](#clang-tools-extra-clang-tools-extra)
  - [LLD (`lld/`)](#lld-lld)
  - [LLDB (`lldb/`)](#lldb-lldb)
  - [MLIR (`mlir/`)](#mlir-mlir)
  ...
  - [compiler-rt (`compiler-rt/`)](#compiler-rt-compiler-rt)
  - [libc++ and libc++abi (`libcxx/`, `libcxxabi/`)](#libc-and-libcabi-libcxx-libcxxabi)
  - [libunwind (`libunwind/`)](#libunwind-libunwind)
  - [BOLT (`bolt/`)](#bolt-bolt)
  - [LLVM libc (`libc/`)](#llvm-libc-libc)
  - [PSTL (`pstl/`)](#pstl-pstl)
- [4. Release Cadence and Versioning](#4-release-cadence-and-versioning)
  - [The Six-Month Major Release Cycle](#the-six-month-major-release-cycle)
  - [Branch Cut and RC Sequence](#branch-cut-and-rc-sequence)
  - [Point Releases](#point-releases)
  - [LLVM Version Numbering History](#llvm-version-numbering-history)
  - [Backport Policy](#backport-policy)
- [5. The Umbrella Model and CMake Integration](#5-the-umbrella-model-and-cmake-integration)
  - [Co-Versioning Under a Single Tag](#co-versioning-under-a-single-tag)
  - [CMake Integration: `LLVM_ENABLE_PROJECTS` and `LLVM_ENABLE_RUNTIMES`](#cmake-integration-llvmenableprojects-and-llvmenableruntimes)
  - [ABI Stability: Public vs. Internal APIs](#abi-stability-public-vs-internal-apis)
  - [The `LLVM_VERSION_MAJOR` Guard Pattern](#the-llvmversionmajor-guard-pattern)
  - [The Component Model and `llvm-config`](#the-component-model-and-llvm-config)
- [6. What LLVM Is Not](#6-what-llvm-is-not)
  - [Not a Single Compiler](#not-a-single-compiler)
  - [Not a Language](#not-a-language)
  - [Not a Runtime](#not-a-runtime)
  - [Comparison with GCC](#comparison-with-gcc)
  - [Not a Monolith Frozen by Compatibility](#not-a-monolith-frozen-by-compatibility)
- [7. The Downstream Ecosystem](#7-the-downstream-ecosystem)
  - [Apple's Toolchain Fork](#apples-toolchain-fork)
  - [Android's LLVM (NDK and AOSP)](#androids-llvm-ndk-and-aosp)
  - [Rust's `rustc_codegen_llvm`](#rusts-rustccodegenllvm)
  - [Swift](#swift)
  - [Zig](#zig)
  - [Intel, AMD, and NVIDIA Downstreams](#intel-amd-and-nvidia-downstreams)
  - [Qualcomm's Fork](#qualcomms-fork)
  - [Other Notable Downstreams](#other-notable-downstreams)
