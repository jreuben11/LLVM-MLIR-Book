...
- [24.1 The Anatomy of an Intrinsic](#241-the-anatomy-of-an-intrinsic)
  - [24.1.1 Declaration Format](#2411-declaration-format)
  - [24.1.2 Overloading](#2412-overloading)
  - [24.1.3 The IntrinsicInst Class Hierarchy](#2413-the-intrinsicinst-class-hierarchy)
  - [24.1.4 TableGen Definition Structure](#2414-tablegen-definition-structure)
- [24.2 Intrinsic Attributes and Their Optimizer Implications](#242-intrinsic-attributes-and-their-optimizer-implications)
  - [24.2.1 Memory Effect Attributes](#2421-memory-effect-attributes)
  - [24.2.2 Control-Flow and Termination Attributes](#2422-control-flow-and-termination-attributes)
- [24.3 Variable Argument Intrinsics](#243-variable-argument-intrinsics)
- [24.4 Memory Intrinsics](#244-memory-intrinsics)
  - [24.4.1 memcpy, memmove, and memset](#2441-memcpy-memmove-and-memset)
  - [24.4.2 Inline Variants](#2442-inline-variants)
  - [24.4.3 Atomic Element-Unordered Variants](#2443-atomic-element-unordered-variants)
  - [24.4.4 The AnyMemIntrinsic Class](#2444-the-anymemintrinsic-class)
- [24.5 Floating-Point Math Intrinsics](#245-floating-point-math-intrinsics)
  - [24.5.1 Correctly-Rounded Operations](#2451-correctly-rounded-operations)
  - [24.5.2 Transcendental Functions](#2452-transcendental-functions)
  - [24.5.3 Rounding Modes](#2453-rounding-modes)
  - [24.5.4 Fast-Math Flags and Math Intrinsics](#2454-fast-math-flags-and-math-intrinsics)
- [24.6 Bit-Manipulation Intrinsics](#246-bit-manipulation-intrinsics)
  - [24.6.1 Byte and Bit Reversal](#2461-byte-and-bit-reversal)
  - [24.6.2 Population Count and Leading/Trailing Zeros](#2462-population-count-and-leadingtrailing-zeros)
  - [24.6.3 Funnel Shifts](#2463-funnel-shifts)
- [24.7 Arithmetic with Overflow and Saturation](#247-arithmetic-with-overflow-and-saturation)
  - [24.7.1 Overflow-Checking Intrinsics](#2471-overflow-checking-intrinsics)
  - [24.7.2 Saturating Arithmetic](#2472-saturating-arithmetic)
- [24.8 Vector Reduction Intrinsics](#248-vector-reduction-intrinsics)
- [24.9 Masked Vector Intrinsics](#249-masked-vector-intrinsics)
  - [24.9.1 Masked Load and Store](#2491-masked-load-and-store)
  - [24.9.2 Masked Gather and Scatter](#2492-masked-gather-and-scatter)
  - [24.9.3 Expand Load and Compress Store](#2493-expand-load-and-compress-store)
- [24.10 Scalable Vector Intrinsics](#2410-scalable-vector-intrinsics)
  - [24.10.1 Step Vector and Insert/Extract](#24101-step-vector-and-insertextract)
- [24.11 Lifetime and Invariant Intrinsics](#2411-lifetime-and-invariant-intrinsics)
  - [24.11.1 Lifetime Markers](#24111-lifetime-markers)
  - [24.11.2 Invariant Intrinsics](#24112-invariant-intrinsics)
  - [24.11.3 Invariant Group Intrinsics](#24113-invariant-group-intrinsics)
- [24.12 Pointer Authentication and Security Intrinsics](#2412-pointer-authentication-and-security-intrinsics)
  - [24.12.1 Pointer Authentication (PAC)](#24121-pointer-authentication-pac)
  - [24.12.2 Stack Save and Restore](#24122-stack-save-and-restore)
  - [24.12.3 Object Size Query](#24123-object-size-query)
- [24.13 Exception Handling Intrinsics](#2413-exception-handling-intrinsics)
  - [24.13.1 Type ID Intrinsic](#24131-type-id-intrinsic)
  - [24.13.2 Setjmp/Longjmp EH](#24132-setjmplongjmp-eh)
  - [24.13.3 WebAssembly Exception Handling](#24133-webassembly-exception-handling)
- [24.14 Debugging and Profiling Intrinsics](#2414-debugging-and-profiling-intrinsics)
  - [24.14.1 Debug Variable Intrinsics](#24141-debug-variable-intrinsics)
  - [24.14.2 Profiling Intrinsics](#24142-profiling-intrinsics)
  - [24.14.3 Pseudo-Probe Intrinsics](#24143-pseudo-probe-intrinsics)
- [24.15 Coroutine Intrinsics](#2415-coroutine-intrinsics)
- [24.16 Target-Specific Intrinsics](#2416-target-specific-intrinsics)
  - [24.16.1 Naming Convention and Organization](#24161-naming-convention-and-organization)
  - [24.16.2 x86 Intrinsics](#24162-x86-intrinsics)
  - [24.16.3 AArch64 Intrinsics](#24163-aarch64-intrinsics)
  - [24.16.4 RISC-V Vector Intrinsics](#24164-risc-v-vector-intrinsics)
  - [24.16.5 The IntrinsicInfo and getTgtMemIntrinsic Machinery](#24165-the-intrinsicinfo-and-gettgtmemintrinsic-machinery)
- [24.17 Miscellaneous Intrinsics](#2417-miscellaneous-intrinsics)
  - [24.17.1 Assume](#24171-assume)
  - [24.17.2 Trap and Debug Trap](#24172-trap-and-debug-trap)
  - [24.17.3 sideeffect and convergent](#24173-sideeffect-and-convergent)
  - [24.17.4 Freeze](#24174-freeze)
- [24.18 Working with Intrinsics Programmatically](#2418-working-with-intrinsics-programmatically)
  - [24.18.1 Querying Intrinsic ID](#24181-querying-intrinsic-id)
  - [24.18.2 Creating Intrinsic Calls](#24182-creating-intrinsic-calls)
  - [24.18.3 Matching Intrinsics in Patterns](#24183-matching-intrinsics-in-patterns)
- [24.19 Chapter Summary](#2419-chapter-summary)
