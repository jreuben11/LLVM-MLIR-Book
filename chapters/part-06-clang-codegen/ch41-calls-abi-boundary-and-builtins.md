...
- [41.1 The ABI Abstraction Layer](#411-the-abi-abstraction-layer)
  - [41.1.1 Source-Level Declaration vs ABI-Lowered Form](#4111-source-level-declaration-vs-abi-lowered-form)
  - [41.1.2 `ABIInfo` Base Class](#4112-abiinfo-base-class)
  - [41.1.3 `TargetCodeGenInfo`](#4113-targetcodegeninfo)
- [41.2 `ABIArgInfo` — Classification Outcomes](#412-abiarginfo-classification-outcomes)
  - [41.2.1 Kind Taxonomy](#4121-kind-taxonomy)
  - [41.2.2 Key Accessors](#4122-key-accessors)
- [41.3 `CGFunctionInfo` — The ABI-Lowered Signature](#413-cgfunctioninfo-the-abi-lowered-signature)
  - [41.3.1 Structure](#4131-structure)
  - [41.3.2 Calling Convention Fields](#4132-calling-convention-fields)
  - [41.3.3 Arrangement Entry Points](#4133-arrangement-entry-points)
- [41.4 Target-Specific ABI Implementations](#414-target-specific-abi-implementations)
  - [41.4.1 x86-64 System V (`X86_64ABIInfo`)](#4141-x86-64-system-v-x8664abiinfo)
  - [41.4.2 Windows x86-64 (`WinX86_64ABIInfo`)](#4142-windows-x86-64-winx8664abiinfo)
  - [41.4.3 AArch64 AAPCS64 (`AArch64ABIInfo`)](#4143-aarch64-aapcs64-aarch64abiinfo)
  - [41.4.4 ARM 32-bit (`ARMABIInfo`)](#4144-arm-32-bit-armabiinfo)
  - [41.4.5 RISC-V (`RISCVABIInfo`)](#4145-risc-v-riscvabiinfo)
  - [41.4.6 Calling Convention Table](#4146-calling-convention-table)
- [41.5 `EmitCall()` and Argument Marshaling](#415-emitcall-and-argument-marshaling)
  - [41.5.1 `CallArgList` Assembly](#4151-callarglist-assembly)
  - [41.5.2 `EmitCall()` Signature](#4152-emitcall-signature)
  - [41.5.3 Argument Coercion](#4153-argument-coercion)
  - [41.5.4 sret Insertion](#4154-sret-insertion)
  - [41.5.5 `EmitCallOrInvoke()`](#4155-emitcallorinvoke)
  - [41.5.6 Argument Evaluation Order and Side Effects](#4156-argument-evaluation-order-and-side-effects)
- [41.6 Return Value Handling](#416-return-value-handling)
  - [41.6.1 sret: Large Aggregate Returns](#4161-sret-large-aggregate-returns)
  - [41.6.2 Direct Return with Coercion](#4162-direct-return-with-coercion)
  - [41.6.3 Scalar and Vector Returns](#4163-scalar-and-vector-returns)
- [41.7 `EmitFunctionProlog()` and `EmitFunctionEpilog()`](#417-emitfunctionprolog-and-emitfunctionepilog)
  - [41.7.1 Parameter Binding in `EmitFunctionProlog()`](#4171-parameter-binding-in-emitfunctionprolog)
  - [41.7.2 Return in `EmitFunctionEpilog()`](#4172-return-in-emitfunctionepilog)
- [41.8 `__builtin_*` Lowering](#418-builtin-lowering)
  - [41.8.1 `EmitBuiltinExpr()` Dispatch](#4181-emitbuiltinexpr-dispatch)
  - [41.8.2 Memory Builtins](#4182-memory-builtins)
  - [41.8.3 Math Builtins](#4183-math-builtins)
  - [41.8.4 Overflow Builtins](#4184-overflow-builtins)
  - [41.8.5 `__builtin_object_size` and `__builtin_dynamic_object_size`](#4185-builtinobjectsize-and-builtindynamicobjectsize)
  - [41.8.6 Architecture-Specific Builtins](#4186-architecture-specific-builtins)
  - [41.8.7 `__builtin_expect` and `__builtin_unpredictable`](#4187-builtinexpect-and-builtinunpredictable)
  - [41.8.8 `__builtin_prefetch`](#4188-builtinprefetch)
- [41.9 `__sync_*` and `__atomic_*` Lowering](#419-sync-and-atomic-lowering)
  - [41.9.1 GCC `__sync_*` Builtins](#4191-gcc-sync-builtins)
  - [41.9.2 C11 `_Atomic` and `<stdatomic.h>`](#4192-c11-atomic-and-stdatomich)
  - [41.9.3 `AtomicInfo` and Lock-Free Width](#4193-atomicinfo-and-lock-free-width)
- [41.10 Variadic Functions](#4110-variadic-functions)
  - [41.10.1 `va_list` Representation on x86-64](#41101-valist-representation-on-x86-64)
  - [41.10.2 `__builtin_va_start` and `__builtin_va_end`](#41102-builtinvastart-and-builtinvaend)
  - [41.10.3 `va_arg` Lowering via `X86_64ABIInfo::EmitVAArg()`](#41103-vaarg-lowering-via-x8664abiinfoemitvaarg)
  - [41.10.4 ARM and AArch64 `va_arg`](#41104-arm-and-aarch64-vaarg)
  - [41.10.5 `__builtin_va_copy`](#41105-builtinvacopy)
- [41.11 Function Pointers and Indirect Calls](#4111-function-pointers-and-indirect-calls)
  - [41.11.1 `CGCalleeInfo` and Callee Resolution](#41111-cgcalleeinfo-and-callee-resolution)
  - [41.11.2 Indirect Calls via `EmitIndirectCallee()`](#41112-indirect-calls-via-emitindirectcallee)
  - [41.11.3 Pointer Authentication on AArch64](#41113-pointer-authentication-on-aarch64)
  - [41.11.4 Virtual Function Pointers](#41114-virtual-function-pointers)
  - [41.11.5 `musttail` Call Lowering](#41115-musttail-call-lowering)
- [41.12 ObjC Message Sends and Block Invocations](#4112-objc-message-sends-and-block-invocations)
  - [41.12.1 Block Invocations](#41121-block-invocations)
  - [41.12.2 ObjC `objc_msgSend`](#41122-objc-objcmsgsend)
  - [41.12.3 ARC Runtime Calls](#41123-arc-runtime-calls)
- [Summary](#summary)
