...
- [42.1 The Itanium C++ ABI: Scope and Implementation Entry Point](#421-the-itanium-c-abi-scope-and-implementation-entry-point)
- [42.2 Name Mangling](#422-name-mangling)
  - [42.2.1 The `_Z` Prefix and `CXXNameMangler`](#4221-the-z-prefix-and-cxxnamemangler)
  - [42.2.2 Encoding Structure](#4222-encoding-structure)
  - [42.2.3 Verified Examples](#4223-verified-examples)
  - [42.2.4 Template Specializations](#4224-template-specializations)
  - [42.2.5 Operator Encoding](#4225-operator-encoding)
  - [42.2.6 Substitution Compression](#4226-substitution-compression)
  - [42.2.7 Local Names and Lambda Encodings](#4227-local-names-and-lambda-encodings)
  - [42.2.8 Demangling with `llvm-cxxfilt`](#4228-demangling-with-llvm-cxxfilt)
- [42.3 Virtual Table Layout](#423-virtual-table-layout)
  - [42.3.1 The Itanium Vtable Memory Model](#4231-the-itanium-vtable-memory-model)
  - [42.3.2 Primary and Secondary Vtables](#4232-primary-and-secondary-vtables)
  - [42.3.3 Virtual Base Offset and VCall Offset Entries](#4233-virtual-base-offset-and-vcall-offset-entries)
  - [42.3.4 VTT: Virtual Table Table](#4234-vtt-virtual-table-table)
  - [42.3.5 VTable Symbols Summary](#4235-vtable-symbols-summary)
- [42.4 Vptr Initialization](#424-vptr-initialization)
  - [42.4.1 Order of Vptr Stores](#4241-order-of-vptr-stores)
  - [42.4.2 Destructor Vptr Reset](#4242-destructor-vptr-reset)
- [42.5 Virtual Dispatch](#425-virtual-dispatch)
  - [42.5.1 `EmitCXXMemberVirtualCallExpr`](#4251-emitcxxmembervirtualcallexpr)
  - [42.5.2 This-Adjustment Thunks](#4252-this-adjustment-thunks)
  - [42.5.3 Covariant Return Thunks](#4253-covariant-return-thunks)
- [42.6 RTTI Representation](#426-rtti-representation)
  - [42.6.1 The `std::type_info` Hierarchy](#4261-the-stdtypeinfo-hierarchy)
  - [42.6.2 LLVM IR for RTTI Objects](#4262-llvm-ir-for-rtti-objects)
  - [42.6.3 `dynamic_cast` Lowering](#4263-dynamiccast-lowering)
- [42.7 Constructor and Destructor Variants](#427-constructor-and-destructor-variants)
  - [42.7.1 The C1/C2/C3 and D0/D1/D2 Scheme](#4271-the-c1c2c3-and-d0d1d2-scheme)
  - [42.7.2 Verified C1/C2 Distinction](#4272-verified-c1c2-distinction)
  - [42.7.3 D0 (Deleting Destructor) IR](#4273-d0-deleting-destructor-ir)
- [42.8 Guard Variables for Static Locals](#428-guard-variables-for-static-locals)
  - [42.8.1 The Double-Checked Locking Protocol](#4281-the-double-checked-locking-protocol)
  - [42.8.2 Apple Platform Difference](#4282-apple-platform-difference)
  - [42.8.3 `__cxa_guard_acquire` Semantics](#4283-cxaguardacquire-semantics)
- [42.9 `operator new` and `operator delete` Lowering](#429-operator-new-and-operator-delete-lowering)
  - [42.9.1 `EmitCXXNewExpr`](#4291-emitcxxnewexpr)
  - [42.9.2 Array New Cookies](#4292-array-new-cookies)
  - [42.9.3 Virtual Delete](#4293-virtual-delete)
  - [42.9.4 Sized Deallocation (C++14)](#4294-sized-deallocation-c14)
- [42.10 Thread-Local Storage and `__cxa_thread_atexit`](#4210-thread-local-storage-and-cxathreadatexit)
  - [42.10.1 Non-Trivial TLS Initialization](#42101-non-trivial-tls-initialization)
  - [42.10.2 `__cxa_thread_atexit` Semantics](#42102-cxathreadatexit-semantics)
  - [42.10.3 TLS Access Models and `_tlsdesc`](#42103-tls-access-models-and-tlsdesc)
- [42.11 Exception Personality and Stack Unwinding](#4211-exception-personality-and-stack-unwinding)
  - [42.11.1 `__gxx_personality_v0`](#42111-gxxpersonalityv0)
  - [42.11.2 Throw Sequence](#42112-throw-sequence)
  - [42.11.3 Catch and Landing Pads](#42113-catch-and-landing-pads)
  - [42.11.4 LSDA Generation](#42114-lsda-generation)
  - [42.11.5 `llvm.eh.typeid.for` Intrinsic](#42115-llvmehtypeidfor-intrinsic)
  - [42.11.6 `_Unwind_Resume` and `__cxa_rethrow`](#42116-unwindresume-and-cxarethrow)
- [42.12 ABI Compatibility Flags](#4212-abi-compatibility-flags)
  - [42.12.1 `-fabi-version=N`](#42121-fabi-versionn)
  - [42.12.2 `-fabi-compat-version=N`](#42122-fabi-compat-versionn)
  - [42.12.3 `-Wabi` Diagnostics](#42123-wabi-diagnostics)
  - [42.12.4 Checking the Active ABI Version](#42124-checking-the-active-abi-version)
  - [42.12.5 ABI Stability in Practice](#42125-abi-stability-in-practice)
- [42.13 The CGCXXABI Abstraction Layer](#4213-the-cgcxxabi-abstraction-layer)
