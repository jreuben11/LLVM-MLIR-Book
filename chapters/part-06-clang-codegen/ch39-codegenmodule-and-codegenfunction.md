...
- [39.1 The Codegen Pipeline Entry Point](#391-the-codegen-pipeline-entry-point)
  - [39.1.1 `CodeGenAction` and `BackendConsumer`](#3911-codegenaction-and-backendconsumer)
  - [39.1.2 `CodeGenerator` ASTConsumer](#3912-codegenerator-astconsumer)
  - [39.1.3 `CodeGenModule` vs `CodeGenFunction`: Ownership and Split](#3913-codegenmodule-vs-codegenfunction-ownership-and-split)
- [39.2 `CodeGenModule` Architecture](#392-codegenmodule-architecture)
  - [39.2.1 Core Data Members](#3921-core-data-members)
  - [39.2.2 `EmitGlobal()` Dispatch](#3922-emitglobal-dispatch)
  - [39.2.3 `DeferredDeclsToEmit` Queue](#3923-deferreddeclstoemit-queue)
  - [39.2.4 `MangledDeclNames` and the Mangling Cache](#3924-mangleddeclnames-and-the-mangling-cache)
  - [39.2.5 Linkage Determination](#3925-linkage-determination)
- [39.3 `CodeGenTypes`: Type Conversion](#393-codegentypes-type-conversion)
  - [39.3.1 `ConvertType()` Pipeline](#3931-converttype-pipeline)
  - [39.3.2 `CGRecordLayout` and Struct Lowering](#3932-cgrecordlayout-and-struct-lowering)
  - [39.3.3 `GetFunctionType()` and ABI-Adjusted Signatures](#3933-getfunctiontype-and-abi-adjusted-signatures)
- [39.4 `CodeGenFunction` Lifecycle](#394-codegenfunction-lifecycle)
  - [39.4.1 Construction](#3941-construction)
  - [39.4.2 `StartFunction()`](#3942-startfunction)
  - [39.4.3 `FinishFunction()`](#3943-finishfunction)
  - [39.4.4 Key Per-Function Fields](#3944-key-per-function-fields)
- [39.5 Basic Block and Control Flow Management](#395-basic-block-and-control-flow-management)
  - [39.5.1 `createBasicBlock()` and `EmitBlock()`](#3951-createbasicblock-and-emitblock)
  - [39.5.2 `JumpDest` and Cleanup Depth](#3952-jumpdest-and-cleanup-depth)
  - [39.5.3 `EHStack` and Cleanup Scopes](#3953-ehstack-and-cleanup-scopes)
- [39.6 `Address` and `LValue`](#396-address-and-lvalue)
  - [39.6.1 The `Address` Type](#3961-the-address-type)
  - [39.6.2 `LValue` — Memory Location with Metadata](#3962-lvalue-memory-location-with-metadata)
  - [39.6.3 `EmitLValue()` and the Load/Store Protocol](#3963-emitlvalue-and-the-loadstore-protocol)
- [39.7 Alloca Management](#397-alloca-management)
  - [39.7.1 The `AllocaInsertPt` Invariant](#3971-the-allocainsertpt-invariant)
  - [39.7.2 `EmitAutoVarAlloca()` and Local Variables](#3972-emitautovaralloca-and-local-variables)
  - [39.7.3 Lifetime Markers](#3973-lifetime-markers)
- [39.8 `CGBuilderTy` and IR Generation](#398-cgbuilderty-and-ir-generation)
  - [39.8.1 Architecture of `CGBuilderTy`](#3981-architecture-of-cgbuilderty)
  - [39.8.2 TBAA Metadata Attachment](#3982-tbaa-metadata-attachment)
  - [39.8.3 Range and Loop Metadata](#3983-range-and-loop-metadata)
- [39.9 Function Attributes and Prologue](#399-function-attributes-and-prologue)
  - [39.9.1 `SetLLVMFunctionAttributes()` and `SetLLVMFunctionAttributesForDefinition()`](#3991-setllvmfunctionattributes-and-setllvmfunctionattributesfordefinition)
  - [39.9.2 Mapping Clang Attributes to LLVM Attributes](#3992-mapping-clang-attributes-to-llvm-attributes)
  - [39.9.3 Target-Feature Attributes](#3993-target-feature-attributes)
- [39.10 Global Variable Emission](#3910-global-variable-emission)
  - [39.10.1 `EmitGlobalVarDefinition()`](#39101-emitglobalvardefinition)
  - [39.10.2 `AppendToGlobalCtors()` and Static Initializers](#39102-appendtoglobalctors-and-static-initializers)
  - [39.10.3 Thread-Local Storage](#39103-thread-local-storage)
- [39.11 `CGDebugInfo`](#3911-cgdebuginfo)
  - [39.11.1 Debug Verbosity Levels](#39111-debug-verbosity-levels)
  - [39.11.2 Debug Intrinsics: RemoveDIs (LLVM 19+)](#39112-debug-intrinsics-removedis-llvm-19)
  - [39.11.3 `EmitFunctionStart()` and Lexical Blocks](#39113-emitfunctionstart-and-lexical-blocks)
- [39.12 Deferred and Lazy Emission](#3912-deferred-and-lazy-emission)
  - [39.12.1 `EmitTopLevelDecl()` Entry](#39121-emittopleveldecl-entry)
  - [39.12.2 Interaction with `-O0` vs `-O2`](#39122-interaction-with-o0-vs-o2)
  - [39.12.3 `EmitDeferredDecls()` Final Drain](#39123-emitdeferreddecls-final-drain)
- [39.13 A Complete Emission Trace](#3913-a-complete-emission-trace)
