...
- [1. Dependent Types: Π and Σ Types](#1-dependent-types-and-types)
  - [The Motivation](#the-motivation)
  - [Π Types (Dependent Function Types)](#types-dependent-function-types)
  - [Σ Types (Dependent Pair / Dependent Sum)](#types-dependent-pair-dependent-sum)
  - [Identity Types and the J Eliminator](#identity-types-and-the-j-eliminator)
  - [Universes and Girard's Paradox](#universes-and-girards-paradox)
- [2. Martin-Löf Type Theory](#2-martin-lf-type-theory)
  - [The Four Judgments](#the-four-judgments)
  - [The Basic Types](#the-basic-types)
  - [Definitional vs. Propositional Equality](#definitional-vs-propositional-equality)
  - [Propositions as Types: The BHK Interpretation](#propositions-as-types-the-bhk-interpretation)
- [3. The Calculus of Constructions and Coq's CIC](#3-the-calculus-of-constructions-and-coqs-cic)
  - [Coquand and Huet's Calculus of Constructions](#coquand-and-huets-calculus-of-constructions)
  - [The λ-Cube](#the-cube)
  - [Coq's Calculus of Inductive Constructions](#coqs-calculus-of-inductive-constructions)
  - [Lean 4's Dependent Type Theory](#lean-4s-dependent-type-theory)
- [4. Subtyping: Width, Depth, Structural, and Nominal](#4-subtyping-width-depth-structural-and-nominal)
  - [The Subtype Relation](#the-subtype-relation)
  - [Width Subtyping for Records](#width-subtyping-for-records)
  - [Depth Subtyping for Records](#depth-subtyping-for-records)
  - [Structural vs. Nominal Subtyping](#structural-vs-nominal-subtyping)
  - [The Liskov Substitution Principle](#the-liskov-substitution-principle)
  - [Subtyping for Function Types](#subtyping-for-function-types)
- [5. Bounded Quantification: System F<:](#5-bounded-quantification-system-f)
  - [Extending System F with Subtyping](#extending-system-f-with-subtyping)
  - [Kernel F<: vs. Full F<:](#kernel-f-vs-full-f)
  - [F-Bounded Polymorphism and Java Generics](#f-bounded-polymorphism-and-java-generics)
- [6. Linear Logic and Linear Types](#6-linear-logic-and-linear-types)
  - [Girard's Linear Logic](#girards-linear-logic)
  - [Linear Types in Programming Languages](#linear-types-in-programming-languages)
  - [Affine and Relevant Types](#affine-and-relevant-types)
  - [The Linear λ-Calculus](#the-linear-calculus)
- [7. Affine Types and Rust's Borrow Checker](#7-affine-types-and-rusts-borrow-checker)
  - [Rust's Ownership as an Affine Type System](#rusts-ownership-as-an-affine-type-system)
  - [Borrowing as Temporary Aliasing](#borrowing-as-temporary-aliasing)
  - [The NLL Borrow Checker as a Flow-Sensitive Type System](#the-nll-borrow-checker-as-a-flow-sensitive-type-system)
  - [RustBelt: The Formal Safety Proof](#rustbelt-the-formal-safety-proof)
  - [Connection to Session Types](#connection-to-session-types)
- [8. Uniqueness Types and Region Types](#8-uniqueness-types-and-region-types)
  - [Uniqueness Types](#uniqueness-types)
  - [Region Types](#region-types)
  - [Cyclone and Safe C with Regions](#cyclone-and-safe-c-with-regions)
- [9. Effect Systems: Koka and Algebraic Effects](#9-effect-systems-koka-and-algebraic-effects)
  - [The Motivation](#the-motivation)
  - [Marino and Millstein's Generic Effect System](#marino-and-millsteins-generic-effect-system)
  - [Koka: Row Polymorphism for Effects](#koka-row-polymorphism-for-effects)
  - [Algebraic Effects and Handlers](#algebraic-effects-and-handlers)
  - [Effect Inference vs. Annotation](#effect-inference-vs-annotation)
  - [The Monad Connection](#the-monad-connection)
- [10. Refinement Types and Liquid Types](#10-refinement-types-and-liquid-types)
  - [Refinement Types](#refinement-types)
  - [Liquid Types](#liquid-types)
  - [LiquidHaskell](#liquidhaskell)
  - [F* and Low*](#f-and-low)
- [11. Gradual Typing](#11-gradual-typing)
  - [The Dynamic Type](#the-dynamic-type)
  - [The Consistency Relation](#the-consistency-relation)
  - [The Gradual Guarantee](#the-gradual-guarantee)
  - [The Blame Calculus](#the-blame-calculus)
  - [Practical Gradual Type Systems](#practical-gradual-type-systems)
- [12. Session Types](#12-session-types)
  - [Session Types Model Communication Protocols](#session-types-model-communication-protocols)
  - [Duality](#duality)
  - [Linear Session Types](#linear-session-types)
  - [Dependent Session Types](#dependent-session-types)
  - [Session Types and the π-Calculus](#session-types-and-the-calculus)
  - [The Curry-Howard Correspondence for Session Types](#the-curry-howard-correspondence-for-session-types)
  - [Implementation](#implementation)
- [13. Dependent Types for Systems Programming: ATS and F*/Low*](#13-dependent-types-for-systems-programming-ats-and-flow)
  - [The Gap Between Theory and Systems](#the-gap-between-theory-and-systems)
  - [ATS: Applied Type System](#ats-applied-type-system)
  - [F* with Low*: Verified C via KreMLin](#f-with-low-verified-c-via-kremlin)
  - [The Compilation Path to LLVM](#the-compilation-path-to-llvm)
  - [The Type-Erasure Spectrum](#the-type-erasure-spectrum)
