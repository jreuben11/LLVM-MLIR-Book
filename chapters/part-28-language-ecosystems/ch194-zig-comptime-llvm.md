...
- [194.1 Architecture: Three Compilation Stages](#1941-architecture-three-compilation-stages)
  - [The Zig Compiler Pipeline](#the-zig-compiler-pipeline)
  - [The Self-Hosted Compiler](#the-self-hosted-compiler)
  - [Target Discovery](#target-discovery)
- [194.2 ZIR: The Syntactic IR](#1942-zir-the-syntactic-ir)
  - [What ZIR Is](#what-zir-is)
  - [ZIR Usage Outside the Compiler](#zir-usage-outside-the-compiler)
- [194.3 AIR: The Analyzed IR](#1943-air-the-analyzed-ir)
  - [From ZIR to AIR](#from-zir-to-air)
  - [A Concrete AIR Example](#a-concrete-air-example)
- [194.4 Comptime: The Metaprogramming Primitive](#1944-comptime-the-metaprogramming-primitive)
  - [The `comptime` Qualifier](#the-comptime-qualifier)
  - [Generic Functions via Comptime Type Parameters](#generic-functions-via-comptime-type-parameters)
  - [`type` as a First-Class Value](#type-as-a-first-class-value)
  - [Reflection with `@typeInfo`](#reflection-with-typeinfo)
  - [Comptime Reflection Intrinsics Reference](#comptime-reflection-intrinsics-reference)
  - [Inline For and Inline While](#inline-for-and-inline-while)
  - [Comparison: Zig Comptime vs. C++ Templates vs. Rust const](#comparison-zig-comptime-vs-c-templates-vs-rust-const)
  - [Comptime HashMap Key Validation Example](#comptime-hashmap-key-validation-example)
  - [Comptime Format String Validation](#comptime-format-string-validation)
- [194.5 Error Handling](#1945-error-handling)
  - [Error Sets and Error Union Types](#error-sets-and-error-union-types)
  - [`try`, `catch`, and `errdefer`](#try-catch-and-errdefer)
  - [Error Return Traces](#error-return-traces)
  - [`anyerror` — The Global Error Set](#anyerror-the-global-error-set)
- [194.6 LLVM IR Generation](#1946-llvm-ir-generation)
  - [Type Mapping: Zig Types to LLVM Types](#type-mapping-zig-types-to-llvm-types)
  - [LLVM IR for Optional Return Type](#llvm-ir-for-optional-return-type)
  - [Error Union IR](#error-union-ir)
  - [Tagged Union IR](#tagged-union-ir)
  - [Packed Structs and Bit-Level Layout](#packed-structs-and-bit-level-layout)
  - [`@Vector` — SIMD Vector Types](#vector-simd-vector-types)
  - [Emitting LLVM IR](#emitting-llvm-ir)
- [194.7 Safety Builds and Runtime Checks](#1947-safety-builds-and-runtime-checks)
  - [The Four Optimization Modes](#the-four-optimization-modes)
  - [Runtime Safety Checks](#runtime-safety-checks)
  - [Per-Block Safety Opt-Out](#per-block-safety-opt-out)
  - [Comparison with Rust Debug/Release](#comparison-with-rust-debugrelease)
- [194.8 Zig as a C Cross-Compiler](#1948-zig-as-a-c-cross-compiler)
  - [The Bundled Toolchain](#the-bundled-toolchain)
  - [Production Usage](#production-usage)
- [194.9 C Interoperability](#1949-c-interoperability)
  - [`@cImport` — C Header Translation](#cimport-c-header-translation)
  - [`zig translate-c`](#zig-translate-c)
  - [`extern` Types and ABI Compatibility](#extern-types-and-abi-compatibility)
- [194.10 The Build System (`build.zig`)](#19410-the-build-system-buildzig)
  - [`build.zig` as a Zig Program](#buildzig-as-a-zig-program)
  - [Minimal `build.zig`](#minimal-buildzig)
  - [Content-Addressed Caching](#content-addressed-caching)
  - [Key `std.Build` API Surface](#key-stdbuild-api-surface)
  - [Lazy Dependency Evaluation](#lazy-dependency-evaluation)
  - [Built-in Test Framework](#built-in-test-framework)
- [194.11 Integration with LLVM's Optimization Pipeline](#19411-integration-with-llvms-optimization-pipeline)
  - [What Zig Passes to LLVM](#what-zig-passes-to-llvm)
