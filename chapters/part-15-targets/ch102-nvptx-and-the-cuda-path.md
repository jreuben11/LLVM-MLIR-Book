...
- [102.1 NVPTX Architecture Overview](#1021-nvptx-architecture-overview)
  - [102.1.1 CUDA Thread Hierarchy](#10211-cuda-thread-hierarchy)
  - [102.1.2 PTX as a Virtual ISA and Compilation Pipeline](#10212-ptx-as-a-virtual-isa-and-compilation-pipeline)
  - [102.1.3 PTX ISM Versions and Compute Capabilities](#10213-ptx-ism-versions-and-compute-capabilities)
  - [102.1.4 The NVPTX Target Triple](#10214-the-nvptx-target-triple)
  - [102.1.5 NVPTX TableGen Instruction Definitions](#10215-nvptx-tablegen-instruction-definitions)
- [102.2 NVPTX Target Machine and Subtarget](#1022-nvptx-target-machine-and-subtarget)
  - [102.2.1 NVPTXTargetMachine](#10221-nvptxtargetmachine)
  - [102.2.2 NVPTXSubtarget](#10222-nvptxsubtarget)
- [102.3 Address Spaces in NVPTX](#1023-address-spaces-in-nvptx)
  - [102.3.1 PTX Memory Hierarchy](#10231-ptx-memory-hierarchy)
  - [102.3.2 Address Space Inference](#10232-address-space-inference)
  - [102.3.3 Shared Memory Declaration](#10233-shared-memory-declaration)
- [102.4 Kernel Entry Points and Launch Parameters](#1024-kernel-entry-points-and-launch-parameters)
  - [102.4.1 Kernel Annotation Metadata](#10241-kernel-annotation-metadata)
  - [102.4.2 PTX Entry Directive and Parameter Passing](#10242-ptx-entry-directive-and-parameter-passing)
  - [102.4.3 Built-in Thread Index Registers](#10243-built-in-thread-index-registers)
- [102.5 NVPTX Instruction Set and Lowering](#1025-nvptx-instruction-set-and-lowering)
  - [102.5.1 Instruction Encoding Categories](#10251-instruction-encoding-categories)
  - [102.5.2 Predicate Registers](#10252-predicate-registers)
  - [102.5.3 Select and Predicate Instructions](#10253-select-and-predicate-instructions)
  - [102.5.5 Multiplication and FMA](#10255-multiplication-and-fma)
  - [102.5.6 Memory and Atomics Example](#10256-memory-and-atomics-example)
  - [102.5.7 Warp-Level Operations](#10257-warp-level-operations)
- [102.6 Warp-Uniform Operations and Divergence](#1026-warp-uniform-operations-and-divergence)
  - [102.6.1 The CUDA SIMT Model](#10261-the-cuda-simt-model)
  - [102.6.2 Divergence Analysis in Practice](#10262-divergence-analysis-in-practice)
  - [102.6.3 Barrier and Synchronization Intrinsics](#10263-barrier-and-synchronization-intrinsics)
  - [102.6.4 Vote Instructions](#10264-vote-instructions)
  - [102.6.5 Tiled Reduction with Shared Memory and Warp Shuffles](#10265-tiled-reduction-with-shared-memory-and-warp-shuffles)
  - [102.6.6 Cooperative Groups and Cluster-Level Synchronization](#10266-cooperative-groups-and-cluster-level-synchronization)
- [102.7 PTX Emission](#1027-ptx-emission)
  - [102.7.1 NVPTXAsmPrinter](#10271-nvptxasmprinter)
  - [102.7.2 Register Naming Conventions](#10272-register-naming-conventions)
  - [102.7.3 Module-Level PTX Structure](#10273-module-level-ptx-structure)
- [102.7b The SelectionDAG Lowering Path](#1027b-the-selectiondag-lowering-path)
  - [102.7b.1 From LLVM IR to Machine Instructions](#1027b1-from-llvm-ir-to-machine-instructions)
  - [102.7b.2 Type Legalization](#1027b2-type-legalization)
- [102.7c Tensor Core Intrinsics](#1027c-tensor-core-intrinsics)
  - [102.7c.1 wmma — First-Generation Tensor Cores (Volta)](#1027c1-wmma-first-generation-tensor-cores-volta)
  - [102.7c.2 Async Memory Copy (Ampere)](#1027c2-async-memory-copy-ampere)
- [102.7d Cooperative Launch and Multi-GPU](#1027d-cooperative-launch-and-multi-gpu)
  - [102.7d.1 Cooperative Groups in PTX](#1027d1-cooperative-groups-in-ptx)
  - [102.7d.2 Performance Considerations for PTX Generation](#1027d2-performance-considerations-for-ptx-generation)
- [102.8 The libNVVM Path](#1028-the-libnvvm-path)
  - [102.8.1 NVVM IR vs Open NVPTX](#10281-nvvm-ir-vs-open-nvptx)
  - [102.8.2 Choosing Between NVPTX and libNVVM](#10282-choosing-between-nvptx-and-libnvvm)
- [102.8b NVPTXTargetLowering: ABI Decisions](#1028b-nvptxtargetlowering-abi-decisions)
  - [102.8b.1 Calling Convention and Return Values](#1028b1-calling-convention-and-return-values)
  - [102.8b.2 Constant Memory and Texture Bindings](#1028b2-constant-memory-and-texture-bindings)
  - [102.8b.3 Inline PTX Assembly in NVPTX](#1028b3-inline-ptx-assembly-in-nvptx)
- [102.9 Debugging and Inspecting PTX](#1029-debugging-and-inspecting-ptx)
  - [102.9.1 Generating PTX with llc](#10291-generating-ptx-with-llc)
  - [102.9.2 IR-Level Pass Inspection](#10292-ir-level-pass-inspection)
  - [102.9.3 cubin Inspection Tools](#10293-cubin-inspection-tools)
  - [102.9.4 Workflow Summary](#10294-workflow-summary)
  - [102.9.5 PTX Versioning and Feature Testing](#10295-ptx-versioning-and-feature-testing)
- [102.10 The NVPTX Pass Pipeline in Detail](#10210-the-nvptx-pass-pipeline-in-detail)
  - [102.10.1 Full Pass Ordering](#102101-full-pass-ordering)
  - [102.10.2 NVPTXLowerArgs in Detail](#102102-nvptxlowerargs-in-detail)
  - [102.10.3 NVPTXInferAddressSpaces in Detail](#102103-nvptxinferaddressspaces-in-detail)
