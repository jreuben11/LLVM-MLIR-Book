...
- [106.1 WebAssembly Target Overview](#1061-webassembly-target-overview)
  - [106.1.1 The WebAssembly Execution Model](#10611-the-webassembly-execution-model)
  - [106.1.2 Wasm Versions and Proposal Status](#10612-wasm-versions-and-proposal-status)
  - [106.1.3 WASI — WebAssembly System Interface](#10613-wasi-webassembly-system-interface)
- [106.2 Wasm Target Machine and Subtarget](#1062-wasm-target-machine-and-subtarget)
  - [106.2.1 Target Registration and Triples](#10621-target-registration-and-triples)
  - [106.2.2 Subtarget Features](#10622-subtarget-features)
  - [106.2.3 Target Machine Structure](#10623-target-machine-structure)
- [106.3 WebAssembly Instruction Selection](#1063-webassembly-instruction-selection)
  - [106.3.1 LLVM Virtual Registers to Wasm Stack](#10631-llvm-virtual-registers-to-wasm-stack)
  - [106.3.2 Wasm Type System Mapping](#10632-wasm-type-system-mapping)
  - [106.3.3 RegStackify Pass](#10633-regstackify-pass)
  - [106.3.4 ExplicitLocals Pass](#10634-explicitlocals-pass)
- [106.4 Structured Control Flow](#1064-structured-control-flow)
  - [106.4.1 The CFGStackify Pass](#10641-the-cfgstackify-pass)
  - [106.4.2 Branch Depth Encoding](#10642-branch-depth-encoding)
  - [106.4.3 Exception Handling](#10643-exception-handling)
- [106.5 Wasm SIMD128](#1065-wasm-simd128)
  - [106.5.1 The v128 Type](#10651-the-v128-type)
  - [106.5.2 Auto-Vectorization to SIMD128](#10652-auto-vectorization-to-simd128)
  - [106.5.3 Wasm SIMD Intrinsics](#10653-wasm-simd-intrinsics)
  - [106.5.4 Tail Call Instructions](#10654-tail-call-instructions)
- [106.6 Wasm Object Format and Linking](#1066-wasm-object-format-and-linking)
  - [106.6.1 Wasm Object Files](#10661-wasm-object-files)
  - [106.6.2 LLD Wasm Linker](#10662-lld-wasm-linker)
  - [106.6.2b LLD Wasm Linker Internals](#10662b-lld-wasm-linker-internals)
  - [106.6.3 Emscripten Toolchain](#10663-emscripten-toolchain)
  - [106.6.4 The Wasm GC Proposal](#10664-the-wasm-gc-proposal)
- [106.7 BPF Target Overview](#1067-bpf-target-overview)
  - [106.7.1 eBPF Architecture](#10671-ebpf-architecture)
  - [106.7.2 BPF Triples and Big-Endian Variant](#10672-bpf-triples-and-big-endian-variant)
  - [106.7.3 BTF — BPF Type Format](#10673-btf-bpf-type-format)
- [106.8 BPF Target Machine and Subtarget](#1068-bpf-target-machine-and-subtarget)
  - [106.8.1 Backend Structure](#10681-backend-structure)
  - [106.8.2 BPF Subtarget Features](#10682-bpf-subtarget-features)
  - [106.8.3 BPF Calling Convention](#10683-bpf-calling-convention)
  - [106.8.3b BPF Instruction Encoding](#10683b-bpf-instruction-encoding)
  - [106.8.4 Target Lowering](#10684-target-lowering)
- [106.9 BPF-Specific Passes and CO-RE](#1069-bpf-specific-passes-and-co-re)
  - [106.9.1 CO-RE: Compile Once, Run Everywhere](#10691-co-re-compile-once-run-everywhere)
  - [106.9.1b BTF Relocation Kinds](#10691b-btf-relocation-kinds)
  - [106.9.2 BPFAbstractMemberAccess Pass](#10692-bpfabstractmemberaccess-pass)
  - [106.9.3 BPFPreserveDIType Pass](#10693-bpfpreserveditype-pass)
  - [106.9.4 BPFMIChecking Pass](#10694-bpfmichecking-pass)
  - [106.9.5 Stack Depth and Loop Restrictions](#10695-stack-depth-and-loop-restrictions)
- [106.10 Clang BPF Toolchain](#10610-clang-bpf-toolchain)
  - [106.10.1 Compilation Pipeline](#106101-compilation-pipeline)
  - [106.10.2 BPF ELF Object Format](#106102-bpf-elf-object-format)
  - [106.10.3 libbpf Loading and CO-RE Relocation](#106103-libbpf-loading-and-co-re-relocation)
  - [106.10.4 bpftrace and bcc](#106104-bpftrace-and-bcc)
- [106.11 XDP, BPF Tail Calls, and sched_ext](#10611-xdp-bpf-tail-calls-and-schedext)
  - [106.11.0 BPF Tail Calls](#106110-bpf-tail-calls)
  - [106.11.0b sched_ext — BPF CPU Scheduler](#106110b-schedext-bpf-cpu-scheduler)
  - [106.11.1 XDP Programs](#106111-xdp-programs)
  - [106.11.1b AF_XDP Zero-Copy Userspace](#106111b-afxdp-zero-copy-userspace)
  - [106.11.2 Vectorization and BPF](#106112-vectorization-and-bpf)
  - [106.11.3 BPF Global Data and Maps](#106113-bpf-global-data-and-maps)
- [106.12 BPF Verifier Interaction and Compiler Cooperation](#10612-bpf-verifier-interaction-and-compiler-cooperation)
  - [106.12.1 What the Verifier Checks](#106121-what-the-verifier-checks)
  - [106.12.2 Writing Verifier-Friendly BPF Programs](#106122-writing-verifier-friendly-bpf-programs)
  - [106.12.3 BPF and LLVM Optimization Interaction](#106123-bpf-and-llvm-optimization-interaction)
- [106.13 Wasm Threads and Atomics](#10613-wasm-threads-and-atomics)
  - [106.13.1 The Wasm Threads Proposal](#106131-the-wasm-threads-proposal)
  - [106.13.2 Wasm Exception Handling Implementation](#106132-wasm-exception-handling-implementation)
  - [106.13.3 Component Model and Interface Types](#106133-component-model-and-interface-types)
- [WASI: The WebAssembly System Interface](#wasi-the-webassembly-system-interface)
  - [WASI Design: Capabilities, Not Ambient Authority](#wasi-design-capabilities-not-ambient-authority)
  - [WASI Preview 1 vs Preview 2](#wasi-preview-1-vs-preview-2)
  - [Clang/LLVM WASI Support](#clangllvm-wasi-support)
  - [Running WASI Programs](#running-wasi-programs)
- [WasmGC: Garbage-Collected WebAssembly](#wasmgc-garbage-collected-webassembly)
  - [The Problem WasmGC Solves](#the-problem-wasmgc-solves)
  - [WasmGC Type System](#wasmgc-type-system)
  - [Clang/LLVM WasmGC Support](#clangllvm-wasmgc-support)
  - [WasmGC and the Host GC](#wasmgc-and-the-host-gc)
  - [WasmGC Binary Size Impact](#wasmgc-binary-size-impact)
- [Chapter 106 Summary](#chapter-106-summary)
