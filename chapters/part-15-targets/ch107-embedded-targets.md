...
- [107.1 Embedded Target Landscape](#1071-embedded-target-landscape)
  - [107.1.1 What Defines an Embedded Target](#10711-what-defines-an-embedded-target)
  - [107.1.2 LLVM-Supported Embedded Targets](#10712-llvm-supported-embedded-targets)
  - [107.1.3 Toolchain Components](#10713-toolchain-components)
- [107.2 ARM Cortex-M (Thumb-2)](#1072-arm-cortex-m-thumb-2)
  - [107.2.1 Cortex-M Profiles](#10721-cortex-m-profiles)
  - [107.2.2 Target Triples and Clang Flags](#10722-target-triples-and-clang-flags)
  - [107.2.3 AAPCS and EABI Register Model](#10723-aapcs-and-eabi-register-model)
  - [107.2.4 Vector Table and Reset Handler](#10724-vector-table-and-reset-handler)
  - [107.2.5 Linker Script](#10725-linker-script)
  - [107.2.5b Thumb-2 Instruction Encoding](#10725b-thumb-2-instruction-encoding)
  - [107.2.6 ARMv8-M TrustZone (CMSE)](#10726-armv8-m-trustzone-cmse)
- [107.3 Cortex-M Code Size Optimization](#1073-cortex-m-code-size-optimization)
  - [107.3.1 -Os vs -Oz](#10731-os-vs-oz)
  - [107.3.2 Machine Outliner](#10732-machine-outliner)
  - [107.3.3 LTO for Dead Code Elimination](#10733-lto-for-dead-code-elimination)
  - [107.3.4 Per-Function Size Attributes](#10734-per-function-size-attributes)
- [107.4 RISC-V Embedded (RV32I/E)](#1074-risc-v-embedded-rv32ie)
  - [107.4.1 RV32I and RV32E](#10741-rv32i-and-rv32e)
  - [107.4.2 Target Triples and ABIs](#10742-target-triples-and-abis)
  - [107.4.3 Linker Relaxation on RISC-V](#10743-linker-relaxation-on-risc-v)
  - [107.4.4 RISC-V Zce and Code Size Extensions](#10744-risc-v-zce-and-code-size-extensions)
- [107.5 AVR Target](#1075-avr-target)
  - [107.5.1 AVR Architecture Peculiarities](#10751-avr-architecture-peculiarities)
  - [107.5.2 LLVM AVR Backend](#10752-llvm-avr-backend)
  - [107.5.3 AVR Register Allocation Challenges](#10753-avr-register-allocation-challenges)
- [107.6 MSP430 Target](#1076-msp430-target)
  - [107.6.1 MSP430 Architecture](#10761-msp430-architecture)
  - [107.6.2 LLVM MSP430 Backend](#10762-llvm-msp430-backend)
  - [107.6.2b MSP430 Addressing Mode Excellence](#10762b-msp430-addressing-mode-excellence)
  - [107.6.3 MSP430 ABI and Interrupts](#10763-msp430-abi-and-interrupts)
  - [107.6.4 Low-Power Mode Transitions](#10764-low-power-mode-transitions)
- [107.7 Code Size Optimization Strategies](#1077-code-size-optimization-strategies)
  - [107.7.1 Size-Affecting Optimizations](#10771-size-affecting-optimizations)
  - [107.7.1b Concrete Size Measurement Example](#10771b-concrete-size-measurement-example)
  - [107.7.2 Identifying Size Bottlenecks](#10772-identifying-size-bottlenecks)
  - [107.7.3 Compiler Flags Summary for Minimum Size](#10773-compiler-flags-summary-for-minimum-size)
- [107.8 Runtime Library Selection](#1078-runtime-library-selection)
  - [107.8.1 compiler-rt Builtins](#10781-compiler-rt-builtins)
  - [107.8.2 C Library Choices](#10782-c-library-choices)
  - [107.8.3 Unwinding and Exceptions](#10783-unwinding-and-exceptions)
- [107.9 Debug Info for Embedded](#1079-debug-info-for-embedded)
  - [107.9.1 DWARF for Constrained Flash](#10791-dwarf-for-constrained-flash)
  - [107.9.2 LLDB Remote Debugging](#10792-lldb-remote-debugging)
  - [107.9.3 SWO/ITM Trace](#10793-swoitm-trace)
- [107.10 Xtensa and Emerging Embedded Targets](#10710-xtensa-and-emerging-embedded-targets)
  - [107.10.1 Xtensa (ESP32) and Windowed Registers](#107101-xtensa-esp32-and-windowed-registers)
  - [107.10.2 ARM Cortex-M55 and Helium (MVE)](#107102-arm-cortex-m55-and-helium-mve)
  - [107.10.3 RISC-V P Extension (Packed SIMD for DSP)](#107103-risc-v-p-extension-packed-simd-for-dsp)
- [107.10b Clang's Bare-Metal Toolchain Driver](#10710b-clangs-bare-metal-toolchain-driver)
  - [107.10b.1 The BareMetal Toolchain Class](#10710b1-the-baremetal-toolchain-class)
  - [107.10b.2 Clang Driver Flags for Embedded](#10710b2-clang-driver-flags-for-embedded)
  - [107.10b.3 Pragma-Based Section Placement](#10710b3-pragma-based-section-placement)
- [107.11 Multilib and Toolchain Configuration](#10711-multilib-and-toolchain-configuration)
  - [107.11.1 Multilib](#107111-multilib)
  - [107.11.2 Clang Multilib Configuration](#107112-clang-multilib-configuration)
- [107.12 Safety-Critical and Certified Embedded Toolchains](#10712-safety-critical-and-certified-embedded-toolchains)
  - [107.12.1 Functional Safety Requirements](#107121-functional-safety-requirements)
  - [107.12.2 MISRA C and Clang-Tidy](#107122-misra-c-and-clang-tidy)
  - [107.12.3 Stack Depth Analysis for Safety](#107123-stack-depth-analysis-for-safety)
  - [107.12.4 Clang Address Sanitizer on Bare Metal](#107124-clang-address-sanitizer-on-bare-metal)
- [Chapter 107 Summary](#chapter-107-summary)
