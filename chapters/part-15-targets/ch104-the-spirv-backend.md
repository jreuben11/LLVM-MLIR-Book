...
- [104.1 SPIR-V Overview](#1041-spir-v-overview)
  - [104.1.1 SPIR-V as a Binary Intermediate Language](#10411-spir-v-as-a-binary-intermediate-language)
  - [104.1.2 SPIR-V Versions and Profiles](#10412-spir-v-versions-and-profiles)
  - [104.1.3 Execution Models](#10413-execution-models)
- [104.2 The LLVM SPIR-V Backend History](#1042-the-llvm-spir-v-backend-history)
  - [104.2.1 Pre-existing Path: Khronos Translator](#10421-pre-existing-path-khronos-translator)
  - [104.2.2 The In-Tree SPIRV Backend](#10422-the-in-tree-spirv-backend)
  - [104.2.3 Design Philosophy](#10423-design-philosophy)
- [104.2b SPIR-V Module Structure Reference](#1042b-spir-v-module-structure-reference)
  - [104.2b.1 A Complete Annotated Module](#1042b1-a-complete-annotated-module)
- [104.3 Target Machine and Configuration](#1043-target-machine-and-configuration)
  - [104.3.1 SPIRVTargetMachine](#10431-spirvtargetmachine)
  - [104.3.2 SPIRVSubtarget](#10432-spirvsubtarget)
  - [104.3.3 Address Spaces in SPIR-V](#10433-address-spaces-in-spir-v)
- [104.4 GlobalISel-Based Instruction Selection](#1044-globalisel-based-instruction-selection)
  - [104.4.1 The SPIR-V IRTranslator](#10441-the-spir-v-irtranslator)
  - [104.4.2 SPIRVLegalizer](#10442-spirvlegalizer)
  - [104.4.3 SPIRVInstructionSelector](#10443-spirvinstructionselector)
  - [104.4.3b MIR Dump After IRTranslator](#10443b-mir-dump-after-irtranslator)
  - [104.4.4 SPIRVGlobalRegistry](#10444-spirvglobalregistry)
  - [104.4.5 Type Annotation Intrinsics](#10445-type-annotation-intrinsics)
- [104.5 The SPIR-V Type System](#1045-the-spir-v-type-system)
  - [104.5.1 Explicit Type Instructions](#10451-explicit-type-instructions)
  - [104.5.2 The Opaque Pointer Problem](#10452-the-opaque-pointer-problem)
  - [104.5.3 Type Deduplication](#10453-type-deduplication)
  - [104.5.4 Verified Type Emission Example](#10454-verified-type-emission-example)
  - [104.5.5 Image and Sampler Types](#10455-image-and-sampler-types)
- [104.6 Capabilities and Extensions](#1046-capabilities-and-extensions)
  - [104.6.1 Capability System](#10461-capability-system)
  - [104.6.2 Extensions](#10462-extensions)
  - [104.6.3 Extended Instruction Sets](#10463-extended-instruction-sets)
  - [104.6.4 Capability Dependencies](#10464-capability-dependencies)
- [104.7 Decoration and Metadata](#1047-decoration-and-metadata)
  - [104.7.1 SPIR-V Decorations](#10471-spir-v-decorations)
  - [104.7.2 Built-in Variables](#10472-built-in-variables)
- [104.8 Emission: SPIR-V Binary Writer](#1048-emission-spir-v-binary-writer)
  - [104.8.1 Binary Word Format](#10481-binary-word-format)
  - [104.8.2 Module Section Order](#10482-module-section-order)
  - [104.8.3 ID Numbering and Binary Decode](#10483-id-numbering-and-binary-decode)
  - [104.8.4 SPIRVAsmPrinter](#10484-spirvasmprinter)
- [104.8b SPIR-V for Vulkan: Logical Addressing Model](#1048b-spir-v-for-vulkan-logical-addressing-model)
  - [104.8b.1 Logical vs Physical Addressing](#1048b1-logical-vs-physical-addressing)
  - [104.8b.2 Interface Variables in Vulkan SPIR-V](#1048b2-interface-variables-in-vulkan-spir-v)
  - [104.8b.3 Push Constants](#1048b3-push-constants)
- [104.9 The Khronos llvm-spirv Translator](#1049-the-khronos-llvm-spirv-translator)
  - [104.9.1 Design and Scope](#10491-design-and-scope)
  - [104.9.2 llvm-spirv Usage](#10492-llvm-spirv-usage)
  - [104.9.3 When to Use Which](#10493-when-to-use-which)
- [104.10 SPIR-V in Vulkan and OpenCL Toolchains](#10410-spir-v-in-vulkan-and-opencl-toolchains)
  - [104.10.1 Clang as a SPIR-V Compiler](#104101-clang-as-a-spir-v-compiler)
  - [104.10.2 GLSL and HLSL to SPIR-V](#104102-glsl-and-hlsl-to-spir-v)
  - [104.10.3 clspv: OpenCL via LLVM](#104103-clspv-opencl-via-llvm)
  - [104.10.4 Validation with SPIRV-Tools](#104104-validation-with-spirv-tools)
  - [104.10.5 The MLIR SPIR-V Dialect](#104105-the-mlir-spir-v-dialect)
- [104.11 Debugging the SPIR-V Backend](#10411-debugging-the-spir-v-backend)
  - [104.11.1 Generating Text vs Binary](#104111-generating-text-vs-binary)
  - [104.11.2 Pass-Level Inspection](#104112-pass-level-inspection)
  - [104.11.3 Validating Output](#104113-validating-output)
  - [104.11.4 Common SPIR-V Validation Errors from the LLVM Backend](#104114-common-spir-v-validation-errors-from-the-llvm-backend)
  - [104.11.5 SPIR-V Optimization with spirv-opt](#104115-spir-v-optimization-with-spirv-opt)
  - [104.11.6 Subgroup and Cooperative Matrix Extensions](#104116-subgroup-and-cooperative-matrix-extensions)
- [104.12 SPIR-V Backend Architecture: End-to-End Summary](#10412-spir-v-backend-architecture-end-to-end-summary)
  - [104.12.1 Complete Data Flow](#104121-complete-data-flow)
  - [104.12.2 Comparison: SelectionDAG vs GlobalISel for SPIR-V](#104122-comparison-selectiondag-vs-globalisel-for-spir-v)
  - [104.12.3 Portability Across GPU Targets](#104123-portability-across-gpu-targets)
