...
- [103.1 AMDGPU Architecture Overview](#1031-amdgpu-architecture-overview)
  - [103.1.1 GCN vs RDNA Architecture Families](#10311-gcn-vs-rdna-architecture-families)
  - [103.1.2 The Compilation Pipeline](#10312-the-compilation-pipeline)
- [103.2 Target Machine and Subtargets](#1032-target-machine-and-subtargets)
  - [103.2.1 AMDGPUTargetMachine](#10321-amdgputargetmachine)
  - [103.2.2 GCNSubtarget](#10322-gcnsubtarget)
- [103.3 AMDGPU Address Spaces](#1033-amdgpu-address-spaces)
  - [103.3.1 Address Space Mapping](#10331-address-space-mapping)
  - [103.3.2 Address Space Inference and Promotion](#10332-address-space-inference-and-promotion)
- [103.4 Register File Architecture](#1034-register-file-architecture)
  - [103.4.0 Register File Layout Diagram](#10340-register-file-layout-diagram)
  - [103.4.1 VGPR — Vector General-Purpose Registers](#10341-vgpr-vector-general-purpose-registers)
  - [103.4.2 SGPR — Scalar General-Purpose Registers](#10342-sgpr-scalar-general-purpose-registers)
  - [103.4.3 AGPR — Accumulation GPRs](#10343-agpr-accumulation-gprs)
  - [103.4.4 Register Tuples](#10344-register-tuples)
  - [103.4.5 Occupancy](#10345-occupancy)
- [103.5 Instruction Set and Lowering](#1035-instruction-set-and-lowering)
  - [103.5.0 TableGen Instruction Definitions](#10350-tablegen-instruction-definitions)
  - [103.5.1 Instruction Encoding Families](#10351-instruction-encoding-families)
  - [103.5.2 A Complete Kernel Example](#10352-a-complete-kernel-example)
  - [103.5.2b Understanding the GFX1100 Vec-Add Assembly](#10352b-understanding-the-gfx1100-vec-add-assembly)
  - [103.5.3 MFMA Matrix Instructions](#10353-mfma-matrix-instructions)
  - [103.5.3b MFMA Occupancy and Tiling](#10353b-mfma-occupancy-and-tiling)
  - [103.5.3c s_waitcnt and Memory Ordering](#10353c-swaitcnt-and-memory-ordering)
  - [103.5.4 Key Correctness Passes](#10354-key-correctness-passes)
- [103.6 Calling Conventions and Kernel ABI](#1036-calling-conventions-and-kernel-abi)
  - [103.6.1 HSA Kernel Descriptor](#10361-hsa-kernel-descriptor)
  - [103.6.2 Kernel Argument Passing](#10362-kernel-argument-passing)
  - [103.6.3 Implicit Kernel Arguments (GFX9 vs GFX10+)](#10363-implicit-kernel-arguments-gfx9-vs-gfx10)
- [103.6b GFX9 vs GFX10+ Implicit Argument Differences](#1036b-gfx9-vs-gfx10-implicit-argument-differences)
  - [103.6b.1 GFX9 Prefix SGPR Layout](#1036b1-gfx9-prefix-sgpr-layout)
  - [103.6b.2 GFX10/GFX11 Simplified Layout](#1036b2-gfx10gfx11-simplified-layout)
- [103.7 Divergence and Wave-Level Control Flow](#1037-divergence-and-wave-level-control-flow)
  - [103.7.1 The EXEC Mask](#10371-the-exec-mask)
  - [103.7.1b EXEC Mask State Diagram](#10371b-exec-mask-state-diagram)
  - [103.7.2 Ballot and Cross-Lane Communication](#10372-ballot-and-cross-lane-communication)
  - [103.7.3 DPP — Data Parallel Primitives](#10373-dpp-data-parallel-primitives)
  - [103.7.4 s_barrier and Whole-Quad Mode](#10374-sbarrier-and-whole-quad-mode)
- [103.8 LDS: Local Data Share](#1038-lds-local-data-share)
  - [103.8.1 LDS Usage Pattern](#10381-lds-usage-pattern)
  - [103.8.2 Bank Conflicts and Padding](#10382-bank-conflicts-and-padding)
- [103.8b AMDGPU Target Lowering and Legalization](#1038b-amdgpu-target-lowering-and-legalization)
  - [103.8b.1 AMDGPUTargetLowering](#1038b1-amdgputargetlowering)
  - [103.8b.2 SGPR-VGPR Copy Legality](#1038b2-sgpr-vgpr-copy-legality)
  - [103.8b.3 AMDGPUPromoteAlloca](#1038b3-amdgpupromotealloca)
- [103.9 The ROCm Software Stack](#1039-the-rocm-software-stack)
  - [103.9.1 HIP to ELF](#10391-hip-to-elf)
  - [103.9.2 AMDGPU Metadata in ELF](#10392-amdgpu-metadata-in-elf)
  - [103.9.3 Debugging and Profiling](#10393-debugging-and-profiling)
  - [103.9.4 ROCm Profiling Deep Dive](#10394-rocm-profiling-deep-dive)
  - [103.9.5 Shader-Specific Calling Conventions](#10395-shader-specific-calling-conventions)
- [103.10 The AMDGPU Pass Pipeline in Detail](#10310-the-amdgpu-pass-pipeline-in-detail)
  - [103.10.1 GCN-Specific Machine Passes](#103101-gcn-specific-machine-passes)
  - [103.10.2 SIAnnotateControlFlow](#103102-siannotatecontrolflow)
  - [103.10.3 GCN Register Allocation](#103103-gcn-register-allocation)
